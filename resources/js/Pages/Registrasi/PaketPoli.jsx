...
export default function PaketPoli({ auth, patient, bagian, dokter }) {
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        get(`/registrasi/paket-poli?no_mr=${searchMr}`, {
            preserveState: true,
        });
    };
    ...
    return (
        <div className="dashboard-layout">
            <Head title="Pendaftaran Paket Poli - Medilink RS" />
            ...
            <header className="dashboard-navbar glass-card">
                <div className="navbar-brand">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-blue-300/70">Pendaftaran Paket Poli</p>
                    </div>
                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-5">
                                        <div className="form-group">
                                            ...
                                            >
                                                <option value="">-- Pilih Paket Poli --</option>
                                                {bagian.map((b) => (
