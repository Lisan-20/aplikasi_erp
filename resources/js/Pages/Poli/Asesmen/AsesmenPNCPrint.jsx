...
export default function AsesmenPNCPrint({ pasien, answers, petugas }) {
    useEffect(() => {
        window.print();
    }, []);
    ...
    return (
        <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif', fontSize: '12px', color: '#000' }}>
            <Head title={`Cetak Asesmen PNC - ${pasien.nama_pasien}`} />
                ...
                <tbody>
                    <tr>
                        <td width="60%">
                            ...
                            <h3 style={{ margin: 0, fontSize: '14px' }}>ASESMEN AWAL KEPERAWATAN (KANDUNGAN - PNC)</h3>
                        </td>
            ...
            <h4 style={{ margin: '10px 0', borderBottom: '1px solid #ccc' }}>II. PENGKAJIAN PNC</h4>
            <table width="100%" cellPadding="4" style={{ marginBottom: '20px' }}><tbody>{renderRows(filterPemeriksaan(83000, 83300))}</tbody></table>
            ...
            <h4 style={{ margin: '10px 0', borderBottom: '1px solid #ccc' }}>IV. ASUHAN KEPERAWATAN PNC</h4>
            <table width="100%" cellPadding="4" style={{ marginBottom: '20px' }}><tbody>{renderRows(filterPemeriksaan(83300, 84000))}</tbody></table>
