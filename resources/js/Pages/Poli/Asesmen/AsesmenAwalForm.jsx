...
export default function AsesmenAwalForm({ pasien, psikososial, fisik, skalaNyeri = [], resikoJatuh = [], skriningGizi = [], asuhanKeperawatan = [], dischargePlanning = [], radiogroup_val, mode }) {
    // initialize states
    const initializeAnswers = () => {
        let initial = {};
        [...psikososial, ...fisik, ...skalaNyeri, ...resikoJatuh, ...skriningGizi, ...asuhanKeperawatan, ...dischargePlanning].forEach(q => {
    ...
    const handleSubmit = (e) => {
        ...
        const answersArray = Object.values(answers).filter(ans => {
            ...
            // Jika ini adalah range skala nyeri, hanya simpan yang sesuai radiogroup yang dipilih
        ...
        router.post('/poli/asesmen/awal/store', {
            ...
            onSuccess: () => {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Berhasil',
                    text: 'Asesmen Awal Keperawatan berhasil disimpan',
    ...
    return (
        <DashboardLayout>
            <Head title={`Asesmen Awal - ${pasien.nama_pasien}`} />
            ...
            <div className="pl-container" style={{ overflowY: 'auto', paddingBottom: '100px' }}>
                <div className="pl-header">
                    <div>
                        ...
                        <p className="pl-subtitle">Pengkajian Awal & Psikososial</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                            ...
                            <table className="dash-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th style={{width: '40%', verticalAlign: 'middle'}}>Status Psikososial & Spiritual</th>
                                        <th>Hasil</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {renderQuestionRows(psikososial, 0)}
                                </tbody>
                            </table>
                        </div>
                    </div>
                        ...
                        <div className="dash-table">
                            <table className="dash-table">
                                <thead>
                                    <tr>
                                        <th style={{width: '50px', textAlign: 'center'}}>#</th>
                                        <th style={{width: '40%', verticalAlign: 'middle'}}>Pengkajian Awal Keperawatan</th>
                                        <th>Hasil</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {renderQuestionRows(fisik, psikososial.filter(q => q.kd_type && q.kd_type != '0').length)}
                                </tbody>
                            </table>
                        </div>
                    </div>
                    ...
                    {/* Asuhan Keperawatan */}
                    {asuhanKeperawatan.length > 0 && (
                        <div className="glass-panel mb-4">
                            <div className="dash-table">
                                <table className="dash-table">
                                    <thead>
                                        <tr>
                                            <th colSpan="3" style={{backgroundColor: '#f1f5f9', padding: '12px 20px', fontWeight: 'bold', color: '#1e293b'}}>
                                                ASUHAN KEPERAWATAN
                                            </th>
                                        </tr>
                                        <tr>
                                            <th style={{width: '50px', textAlign: 'center'}}>#</th>
                                            <th style={{width: '40%', verticalAlign: 'middle'}}>Nama Pemeriksaan</th>
                                            <th>Hasil</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {renderQuestionRows(asuhanKeperawatan, 0)}
                                    </tbody>
                                </table>
                            </div>
                        </div>
                            ...
                            <div className="dash-table">
                                <table className="dash-table">
                                    <thead>
                                        ...
                                        <tr>
                                            <th style={{width: '50px', textAlign: 'center'}}>#</th>
                                            <th style={{width: '40%', verticalAlign: 'middle'}}>Kriteria Discharge Planning</th>
                                            <th>Keterangan</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {renderQuestionRows(dischargePlanning, 0)}
                                    </tbody>
                                </table>
                            </div>
                        </div>
