...
export default function AsesmenANCForm({ pasien, psikososial, anc, jatuh, gizi, asuhan, discharge, skalaNyeri }) {
    const initializeAnswers = () => {
        let initial = {};
        [...psikososial, ...anc, ...jatuh, ...gizi, ...asuhan, ...discharge, ...skalaNyeri].forEach(q => {
    ...
    const handleSubmit = (e) => {
        ...
        router.post('/poli/asesmen/anc/store', {
            ...
            onSuccess: () => {
                ...
                Swal.fire({ icon: 'success', title: 'Berhasil', text: 'Asesmen ANC berhasil disimpan', confirmButtonColor: '#3b82f6' }).then(() => {
    ...
    return (
        <DashboardLayout>
            <Head title={`Asesmen ANC - ${pasien.nama_pasien}`} />
            <div className="pl-container" style={{ overflowY: 'auto', paddingBottom: '100px' }}>
                <div className="pl-header">
                    <div>
                        <h1 className="pl-title d-flex align-items-center">
                            ...
                            Asesmen Awal Poli Kandungan (ANC)
                        </h1>
                        <p className="pl-subtitle">Pengkajian Awal Kandungan & Asuhan Keperawatan</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="glass-panel mb-4">
                        <div className="dash-table">
                            <table className="dash-table">
                                <thead><tr><th style={{width: '50px', textAlign: 'center'}}>#</th><th style={{width: '40%', verticalAlign: 'middle'}}>Pengkajian ANC</th><th>Hasil</th></tr></thead>
                                <tbody>{renderQuestionRows(anc, 0)}</tbody>
                            </table>
                        </div>
                    </div>
                    ...
                    <div className="glass-panel mb-4">
                        <div className="dash-table">
                            <table className="dash-table">
                                <thead><tr><th style={{width: '50px', textAlign: 'center'}}>#</th><th style={{width: '40%', verticalAlign: 'middle'}}>Asuhan Keperawatan ANC</th><th>Hasil</th></tr></thead>
                    ...
                    <div className="d-flex justify-content-end mb-5">
                        ...
                        <button type="submit" className="btn btn-primary d-flex align-items-center" style={{ borderRadius: '10px', padding: '10px 24px' }} disabled={isSubmitting}>
                            ...
                            {isSubmitting ? 'Menyimpan...' : 'Simpan Asesmen ANC'}
                        </button>
                    </div>
