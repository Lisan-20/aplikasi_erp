...
<html>
<head>
    <title>LAPORAN SENSUS KELURAHAN</title>
    <style>
...
<table class="title-table">
    <tr>
        <td colspan="3" class="title-main">LAPORAN REKAPITULASI SENSUS PASIEN BERDASARKAN KELURAHAN</td>
    </tr>
    <tr>
    ...
    <tbody>
        ...
        @forelse($data as $index => $row)
            ...
            <tr>
                ...
                <td class="text-left font-bold">{{ strtoupper($row->nama_kelurahan) }}</td>
