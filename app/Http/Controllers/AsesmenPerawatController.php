...
class AsesmenPerawatController extends Controller
{
    ...
    public function createAwal($no_kunjungan)
    {
        ...
        if (in_array(64, $emr)) {
            $radiogroup = '1';
        } elseif (in_array(66, $emr)) {
            $radiogroup = '2';
        } elseif (in_array(53, $emr)) {
            $radiogroup = '3';
        } elseif (in_array(54, $emr)) {
            $radiogroup = '4';
        } elseif (in_array(52, $emr)) {
            $radiogroup = '5';
        }
    ...
    public function printAwal($no_kunjungan)
    {
        ...
        if (in_array(64, $emr)) {
            ...
            $skala_nyeri = 'Numeric Rating Scale';
        } elseif (in_array(53, $emr)) {
            $skala_nyeri = 'FLACC';
        } elseif (in_array(54, $emr)) {
            $skala_nyeri = 'CPOT';
    ...
    public function storeRiwayatHamil(Request $request)
    {
        ...
        try {
            ...
            if (! empty($inserts)) {
                DB::table('tc_riwayat_hamil_det')->insert($inserts);
            }
