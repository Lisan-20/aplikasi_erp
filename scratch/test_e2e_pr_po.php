...
try {
    ...
    $req1 = Request::create('/gudang/permintaan-pembelian', 'POST', $reqDataPR);
    $req1->setUserResolver(function () use ($userId) {
        return (object) ['id' => $userId, 'nama_pegawai' => 'Test System'];
    });

    $controller1 = app(PermintaanPembelianController::class);
    ...
    $req2 = Request::create("/manajemen/acc-purchasing/{$pr->id_tc_permohonan}/approve", 'POST');
    $req2->setUserResolver(function () use ($userId) {
        return (object) ['id' => $userId, 'nama_pegawai' => 'Test System'];
    });
    $controller2 = app(AccPurchasingController::class);
    ...
    $req3 = Request::create('/pengadaan/po', 'POST', $reqDataPO);
    $req3->setUserResolver(function () use ($userId) {
        return (object) ['id' => $userId, 'nama_pegawai' => 'Test System'];
    });

    $controller3 = app(PengadaanController::class);
    ...
    $req4 = Request::create('/gudang/penerimaan', 'POST', $reqDataPenerimaan);
    $req4->setUserResolver(function () use ($userId) {
        return (object) ['id' => $userId, 'nama_pegawai' => 'Test System'];
    });

    $controller4 = app(PenerimaanBarangController::class);
