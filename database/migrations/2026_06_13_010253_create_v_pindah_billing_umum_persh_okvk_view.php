...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.v_pindah_billing_umum_persh_okvk
AS
SELECT     TOP (100) PERCENT dbo.mt_master_tarif.kode_tarif, dbo.mt_master_tarif.nama_tarif, dbo.mt_master_tarif.kode_bagian, dbo.mt_bagian.nama_bagian, 
                      dbo.mt_master_tarif_detail.kode_klas, dbo.mt_klas.nama_klas, dbo.tc_trans_pelayanan.bill_rs AS bill_rs_trans, dbo.tc_trans_pelayanan.bill_dr1 AS bill_dr1_trans, 
                      dbo.tc_trans_pelayanan.bill_dr2 AS bill_dr2_trans, dbo.mt_master_tarif_detail.total, dbo.tc_trans_pelayanan.kode_trans_pelayanan, 
                      ...
                      dbo.tc_trans_pelayanan.kode_bagian AS kode_bagian_trans, dbo.tc_trans_pelayanan.jumlah, dbo.tc_trans_pelayanan.bill_rs_jatah, 
                      dbo.tc_trans_pelayanan.bill_dr1_jatah, dbo.tc_trans_pelayanan.bill_dr2_jatah
...
WHERE     (dbo.tc_trans_pelayanan.kode_tc_trans_kasir IS NULL) AND (dbo.tc_trans_pelayanan.kode_tarif IN
                          (SELECT     kode_tarif
                            FROM          dbo.mt_master_tarif_detail_bedah_perusahaan))
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [v_pindah_billing_umum_persh_okvk]");
    }
};
