...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_pengambilan_brg_gizi')) {
            return;
        }

        Schema::create('tc_pengambilan_brg_gizi', function (Blueprint $table) {
            $table->increments('id_tc_pengambilan');
            $table->string('kode_pengambilan', 25)->nullable();
            $table->integer('no_urut_periodik')->nullable();
            $table->dateTime('tgl_pengambilan')->nullable();
            $table->integer('user_id')->nullable();
            $table->integer('jenis_pengambilan')->nullable();
    ...
    {
        Schema::dropIfExists('tc_pengambilan_brg_gizi');
    }
};
