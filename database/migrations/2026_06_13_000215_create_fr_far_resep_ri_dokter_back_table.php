...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('fr_far_resep_ri_dokter_back')) {
            return;
        }

        Schema::create('fr_far_resep_ri_dokter_back', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('fr_far_resep_ri_dokter_back');
    }
};
