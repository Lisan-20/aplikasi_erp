...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.antrian_loket_poli2_v
AS
...
WHERE     (a.status_selesai = 2) AND (a.status_batal IS NULL) AND (dbo.tc_registrasi.status_batal IS NULL) AND (a.kode_tc_trans_kasir IS NULL) AND (YEAR(dbo.tc_registrasi.tgl_jam_masuk) >= 2024)
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [antrian_loket_poli2_v]");
    }
};
