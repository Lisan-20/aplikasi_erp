...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.tc_pemeriksaan_ews4_v
AS
SELECT     TOP (100) PERCENT dbo.tc_pemeriksaan_ews.no_urut_ews, dbo.tc_pemeriksaan_ews.no_registrasi, dbo.tc_pemeriksaan_ews.user_id, dbo.tc_pemeriksaan_ews.tgl_jam, 
                      ...
                      dbo.tc_pemeriksaan_ews_det.hasil AS hasil_x
...
WHERE     (dbo.tc_pemeriksaan_ews.jenis = 4)
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [tc_pemeriksaan_ews4_v]");
    }
};
