...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_pemeriksaan_resum_medis')) {
            return;
        }

        Schema::create('tc_pemeriksaan_resum_medis', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tc_pemeriksaan_resum_medis');
    }
};
