...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.ri_cari_pasien_jkn_pul_v
AS
SELECT     dbo.mt_master_pasien.no_mr, dbo.tc_registrasi.no_registrasi, dbo.tc_kunjungan.no_kunjungan, dbo.ri_tc_rawatinap.kode_ri, dbo.mt_master_pasien.nama_pasien, 
                      ...
                      dbo.ri_tc_rawatinap.status_batal AS batal_ri, dbo.tc_registrasi.noSep, dbo.tc_registrasi.noKartuPeserta, dbo.ri_tc_rawatinap.alos, dbo.tc_registrasi.no_jaminan, dbo.tc_registrasi.no_sjp, 
                      dbo.tc_registrasi.kdDiag
...
WHERE     (dbo.ri_tc_rawatinap.status_pulang = 1) AND (dbo.tc_registrasi.kode_kelompok IN (8, 9, 11, 12)) AND (dbo.tc_kunjungan.status_batal IS NULL)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [ri_cari_pasien_jkn_pul_v]");
    }
};
