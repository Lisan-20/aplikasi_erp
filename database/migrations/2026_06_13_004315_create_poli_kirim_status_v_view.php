...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.poli_kirim_status_v
AS
SELECT     TOP (100) PERCENT dbo.pl_tc_poli.id_pl_tc_poli, dbo.pl_tc_poli.kode_poli, dbo.pl_tc_poli.no_kunjungan, dbo.pl_tc_poli.kode_bagian, dbo.pl_tc_poli.no_antrian, dbo.pl_tc_poli.tgl_jam_poli, 
                      ...
                      AS int) AS DIGIT, dbo.tc_registrasi.flag_p2d
...
WHERE     (dbo.tc_registrasi.flag_status IS NULL)
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [poli_kirim_status_v]");
    }
};
