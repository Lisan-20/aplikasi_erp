...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.pasien_masih_dirawat_v
AS
SELECT     dbo.mt_master_pasien.no_mr, dbo.tc_registrasi.no_registrasi, dbo.tc_kunjungan.no_kunjungan, dbo.ri_tc_rawatinap.kode_ri, dbo.mt_master_pasien.nama_pasien, 
                      ...
                      dbo.ri_tc_rawatinap.status_pulang, dbo.ri_tc_rawatinap.status_cuti, dbo.tc_registrasi.status_registrasi, dbo.tc_registrasi.kode_perusahaan, 
                      dbo.tc_registrasi.kode_kelompok, dbo.ri_tc_rawatinap.no_jkn, dbo.ri_tc_rawatinap.kode_plafon, dbo.ri_tc_rawatinap.plafon_bpjs, dbo.ri_tc_rawatinap.diagnosa_awal, 
                      ...
                      dbo.mt_karyawan.nama_pegawai, dbo.tc_kunjungan.tgl_masuk AS Expr2, dbo.tc_kunjungan.status_batal, dbo.mt_bagian.nama_bagian, dbo.mt_klas.nama_klas, 
                      dbo.tc_registrasi.umur, dbo.mt_master_pasien.almt_ttp_pasien AS alamat, dbo.tc_kunjungan.tgl_pulang
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [pasien_masih_dirawat_v]");
    }
};
