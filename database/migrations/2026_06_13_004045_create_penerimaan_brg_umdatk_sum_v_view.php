...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.penerimaan_brg_umdatk_sum_v
AS
SELECT     TOP (100) PERCENT dbo.transaksi_umd_detail.id_trans_umd, dbo.transaksi_umd.no_bukti, dbo.transaksi_umd_detail.id_tc_permohonan_det, 
                      ...
                      dbo.transaksi_umd_detail.discount_psn, dbo.transaksi_umd_detail.status_batal, dbo.transaksi_umd_detail.status_close, dbo.mt_barang_jasa.nama_brg, 
...
FROM         dbo.tc_permohonan_cash_det_atk INNER JOIN
                      ...
                      dbo.mt_barang_jasa ON dbo.transaksi_umd_detail.kode_brg = dbo.mt_barang_jasa.kode_brg ON 
...
GROUP BY dbo.transaksi_umd_detail.id_trans_umd, dbo.transaksi_umd.no_bukti, dbo.transaksi_umd_detail.id_tc_permohonan_det, dbo.transaksi_umd.status_bayar, 
                      ...
                      dbo.transaksi_umd_detail.status_batal, dbo.transaksi_umd_detail.status_close, dbo.mt_barang_jasa.nama_brg, 
                      dbo.tc_permohonan_cash_atk.kode_permohonan
