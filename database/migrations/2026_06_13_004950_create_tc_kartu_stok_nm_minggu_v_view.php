...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.tc_kartu_stok_brg_jasa_minggu_v
AS
...
FROM         dbo.tc_kartu_stok_brg_jasa
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [tc_kartu_stok_brg_jasa_minggu_v]");
    }
};
