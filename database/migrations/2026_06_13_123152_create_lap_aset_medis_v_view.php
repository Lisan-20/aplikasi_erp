...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.lap_aset_medis_v
AS
...
WHERE     (dbo.mt_biaya_op_detail.kode_ref = 3) AND (dbo.mt_biaya_op_detail.kode_biaya = 1)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [lap_aset_medis_v]");
    }
};
