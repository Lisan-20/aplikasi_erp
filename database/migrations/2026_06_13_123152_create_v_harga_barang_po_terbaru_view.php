...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.v_harga_barang_po_terbaru
AS
SELECT     TOP (100) PERCENT dbo.tc_po_det.kode_brg, dbo.tc_po_det.harga_satuan AS harga_satuan_netto, dbo.tc_po.kodesupplier, dbo.mt_supplier.namasupplier, 
                      dbo.mt_barang.nama_brg, dbo.tc_po.no_po, dbo.tc_po.id_tc_po, dbo.tc_po_det.id_tc_po_det, dbo.tc_po_det.satuan
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [v_harga_barang_po_terbaru]");
    }
};
