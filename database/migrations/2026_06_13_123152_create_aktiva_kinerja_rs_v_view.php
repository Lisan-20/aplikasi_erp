...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.aktiva_kinerja_rs_v
AS
...
GROUP BY dbo.tx_harian.tx_tipe, YEAR(dbo.tx_harian.tx_tgl), MONTH(dbo.tx_harian.tx_tgl), dbo.mt_account.kode_utama
HAVING      (dbo.mt_account.kode_utama = '1')
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [aktiva_kinerja_rs_v]");
    }
};
