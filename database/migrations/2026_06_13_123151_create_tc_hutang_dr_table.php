...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_hutang_dr')) {
            return;
        }

        Schema::create('tc_hutang_dr', function (Blueprint $table) {
            ...
            $table->primary(['id_bd_tc_hutang_dr'], 'pk_tc_hutang_dr');
        });
    }
    ...
    {
        Schema::dropIfExists('tc_hutang_dr');
    }
};
