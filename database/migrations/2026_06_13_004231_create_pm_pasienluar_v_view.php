...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.pm_pasienluar_v
AS
SELECT     dbo.tc_registrasi.status_batal, dbo.tc_registrasi.stat_pasien, dbo.tc_kunjungan.no_kunjungan, dbo.tc_kunjungan.kode_bagian_tujuan, dbo.tc_kunjungan.kode_bagian_asal, 
                      ...
                      dbo.tc_registrasi.no_registrasi, dbo.pm_tc_penunjang.kode_klas, dbo.mt_pasien_penunjang.nama_pasien, dbo.mt_pasien_penunjang.no_pm AS no_mr, dbo.mt_pasien_penunjang.jen_kelamin, 
                      dbo.pm_tc_penunjang.no_hasil_pm, dbo.pm_tc_penunjang.status_bayar, dbo.tc_registrasi.kode_kelompok, dbo.tc_registrasi.status_man, dbo.tc_kunjungan.status_batal AS Expr1, 
                      dbo.mt_pasien_penunjang.tgl_lahir AS tgl_lhr, dbo.mt_pasien_penunjang.dokter_pengirim, dbo.mt_pasien_penunjang.no_tlp
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [pm_pasienluar_v]");
    }
};
