...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.v_trans_pelayanan_pt_RJ_v
AS
SELECT     dbo.tc_trans_pelayanan.kode_trans_pelayanan, dbo.tc_trans_pelayanan.kode_tc_trans_kasir, dbo.tc_trans_pelayanan.no_kunjungan, dbo.tc_registrasi.no_registrasi, 
                      dbo.tc_trans_pelayanan.no_mr, dbo.tc_trans_pelayanan.nama_pasien_layan, dbo.tc_registrasi.kode_kelompok, dbo.tc_registrasi.kode_perusahaan, 
                      ...
                      dbo.tc_trans_pelayanan.flag_jurnal, dbo.tc_trans_kasir.no_kuitansi, dbo.tc_trans_kasir.seri_kuitansi, dbo.mt_perusahaan.flag, dbo.tc_trans_pelayanan.diskon_rs, 
                      dbo.tc_trans_pelayanan.diskon_dr1, dbo.tc_trans_pelayanan.diskon_dr2
...
WHERE     (dbo.tc_trans_pelayanan.flag_jurnal = 0) AND (dbo.tc_trans_kasir.status_batal IS NULL) AND (dbo.tc_trans_pelayanan.jenis_tindakan IN (3, 4, 7, 9)) AND 
                      (dbo.tc_trans_kasir.seri_kuitansi IN ('AJ', 'RJ', 'NK')) AND (dbo.tc_trans_pelayanan.kode_kelompok = 5) AND (dbo.tc_registrasi.kode_perusahaan > 0) AND 
                      (dbo.mt_perusahaan.flag = 0 OR
                      dbo.mt_perusahaan.flag IS NULL) AND (dbo.tc_trans_pelayanan.jenis_tindakan NOT IN (2)) AND (dbo.tc_trans_pelayanan.status_batal IS NULL)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [v_trans_pelayanan_pt_RJ_v]");
    }
};
