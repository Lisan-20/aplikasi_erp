...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.v_jadwal_dokter2
AS
SELECT     TOP (100) PERCENT dbo.mt_jadwal_dokter.kode_dokter, dbo.mt_jadwal_dokter.kode_bagian, dbo.mt_bagian.nama_bagian, dbo.mt_karyawan.nama_pegawai, dbo.mt_karyawan.status, 
                      ...
                      } AS jam_mulai, { fn HOUR(dbo.mt_jadwal_dokter.jam_akhir) } AS jam_akhir, dbo.mt_karyawan.kode_dokter_hfis AS kodeDPJP, dbo.mt_karyawan.flag_aktif, dbo.mt_karyawan.kode_dokter_hfis
...
ORDER BY dbo.mt_bagian.nama_bagian, jam_mulai, dbo.mt_karyawan.nama_pegawai
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [v_jadwal_dokter2]");
    }
};
