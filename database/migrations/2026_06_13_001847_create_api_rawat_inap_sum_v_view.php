...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.api_rawat_inap_sum_v
AS
...
WHERE        (dbo.mt_bagian.kode_bagian LIKE '03%')
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [api_rawat_inap_sum_v]");
    }
};
