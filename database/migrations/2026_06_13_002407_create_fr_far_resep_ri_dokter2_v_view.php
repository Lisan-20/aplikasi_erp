...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.fr_far_resep_ri_dokter2_v
AS
SELECT     dbo.fr_far_resep_ri_dokter.id_resep_ri_dr, dbo.fr_far_resep_ri_dokter.no_registrasi, dbo.fr_far_resep_ri_dokter.no_mr, dbo.fr_far_resep_ri_dokter.kode_dokter, dbo.fr_far_resep_ri_dokter.tgl_input, 
                      ...
                      dbo.fr_far_resep_ri_dokter.kode_rm, dbo.fr_far_resep_ri_dokter.kode_bagian_isi, dbo.mt_bagian.nama_bagian, dbo.fr_far_resep_ri_dokter.isi_cara, dbo.fr_far_resep_ri_dokter.isi_waktu, 
                      dbo.fr_far_resep_ri_dokter.isi_signa, dbo.fr_far_resep_ri_dokter.id_user_alergi, dbo.fr_far_resep_ri_dokter.tgl_ass_alergi, dbo.fr_far_resep_ri_dokter.bentuk_reaksi, 
                      dbo.fr_far_resep_ri_dokter.id_user_rek, dbo.fr_far_resep_ri_dokter.tgl_rek_awal, dbo.fr_far_resep_ri_dokter.st_rek_awal, dbo.fr_far_resep_ri_dokter.st_alergi
FROM         dbo.fr_far_resep_ri_dokter INNER JOIN
                      ...
                      dbo.mt_bagian ON dbo.fr_far_resep_ri_dokter.kode_bagian_isi = dbo.mt_bagian.kode_bagian LEFT OUTER JOIN
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [fr_far_resep_ri_dokter2_v]");
    }
};
