...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_penerimaan_barang_detail')) {
            return;
        }

        Schema::create('tc_penerimaan_barang_detail', function (Blueprint $table) {
            ...
            $table->primary(['kode_detail_penerimaan_barang'], 'pk_tc_penerimaan_barang_detail');
        });
    }
    ...
    {
        Schema::dropIfExists('tc_penerimaan_barang_detail');
    }
};
