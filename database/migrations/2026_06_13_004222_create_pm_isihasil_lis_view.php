...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.pm_isihasil_lis
AS
SELECT dbo.pm_pemeriksaanpasien_v.kode_trans_pelayanan, dbo.pm_pemeriksaanpasien_v.no_registrasi, dbo.pm_pemeriksaanpasien_v.no_mr, dbo.pm_pemeriksaanpasien_v.kode_kelompok, dbo.pm_pemeriksaanpasien_v.kode_perusahaan, dbo.pm_pemeriksaanpasien_v.tgl_transaksi, 
             ...
             dbo.pm_mt_standarhasil.shp_min, dbo.pm_mt_standarhasil.shp_max, dbo.pm_mt_standarhasil.std_text_p, dbo.pm_mt_standarhasil.std_text_l, dbo.pm_pemeriksaanpasien_v.waktu_sampel, dbo.pm_mt_standarhasil.catatan
FROM   dbo.pm_pemeriksaanpasien_v INNER JOIN
             dbo.pm_mt_standarhasil ON dbo.pm_pemeriksaanpasien_v.kode_tarif = dbo.pm_mt_standarhasil.kode_tarif INNER JOIN
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [pm_isihasil_lis]");
    }
};
