...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.tc_lap_dr_nicu_v
AS
...
HAVING      (dbo.tc_registrasi.status_batal IS NULL) AND (NOT (YEAR(dbo.tc_registrasi.tgl_jam_keluar) IS NULL)) AND (NOT (MONTH(dbo.tc_registrasi.tgl_jam_keluar) IS NULL)) 
                      AND (NOT (DAY(dbo.tc_registrasi.tgl_jam_keluar) IS NULL)) AND (dbo.tc_registrasi.kode_bagian_keluar = '032001')
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [tc_lap_dr_nicu_v]");
    }
};
