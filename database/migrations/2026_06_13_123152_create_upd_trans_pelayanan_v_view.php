...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.upd_trans_pelayanan_v
AS
SELECT     dbo.tc_trans_pelayanan.kode_trans_pelayanan, dbo.tc_trans_pelayanan.kode_tc_trans_kasir, dbo.tc_trans_pelayanan.no_kunjungan, 
                      ...
                      dbo.tc_trans_pelayanan.tgl_ver, dbo.tc_trans_kasir.seri_kuitansi
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [upd_trans_pelayanan_v]");
    }
};
