...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.kasbank_d_union_all_v
AS
...
HAVING      (dbo.kasbank_union_all_v.tx_tipe = '0')
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [kasbank_d_union_all_v]");
    }
};
