...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.v_persiapan_potongan_bulanan
AS
SELECT     dbo.tc_transaksi_payroll.npp, dbo.tc_transaksi_payroll.id_kd_transaksi_det, dbo.tc_transaksi_payroll.nominal AS potongan, dbo.tc_transaksi_payroll.tgl_mulai, dbo.tc_transaksi_payroll.tgl_akhir, 
...
FROM         dbo.mt_karyawan INNER JOIN
                      ...
                      dbo.mt_periode_gaji
WHERE     (dbo.tc_transaksi_payroll.id_kd_transaksi = N'3') AND (dbo.mt_periode_gaji.status_periode_gaji IS NULL) AND (dbo.tc_transaksi_payroll.tgl_mulai BETWEEN dbo.mt_periode_gaji.periode_awal AND
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [v_persiapan_potongan_bulanan]");
    }
};
