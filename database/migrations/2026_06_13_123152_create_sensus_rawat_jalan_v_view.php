...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.sensus_rawat_jalan_v
AS
SELECT     dbo.tc_kunjungan.no_mr, dbo.mt_master_pasien.nama_pasien, dbo.pl_tc_poli.kode_poli, dbo.mt_karyawan.nama_pegawai, dbo.tc_kunjungan.tgl_masuk, 
                      dbo.tc_registrasi.stat_pasien, dbo.pl_tc_poli.kode_bagian, dbo.mt_bagian.nama_bagian, dbo.tc_registrasi.no_registrasi, dbo.tc_registrasi.kode_kelompok, 
...
GROUP BY dbo.tc_kunjungan.no_mr, dbo.mt_master_pasien.nama_pasien, dbo.pl_tc_poli.kode_poli, dbo.mt_karyawan.nama_pegawai, dbo.tc_kunjungan.tgl_masuk, 
                      dbo.tc_registrasi.stat_pasien, dbo.pl_tc_poli.kode_bagian, dbo.mt_bagian.nama_bagian, dbo.tc_registrasi.no_registrasi, dbo.tc_registrasi.kode_kelompok, 
                      dbo.tc_registrasi.kode_perusahaan
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [sensus_rawat_jalan_v]");
    }
};
