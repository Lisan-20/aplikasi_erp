...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.rg_inforuang2_v
AS
...
WHERE     (dbo.mt_bagian.validasi = '030001') AND (dbo.mt_ruangan.flag_aktif IS NULL) OR
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [rg_inforuang2_v]");
    }
};
