...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.v_bill_dokter_ri_fee
AS
...
WHERE     (dbo.tc_trans_pelayanan.kode_perusahaan > 0) AND (dbo.fee_dokter_rinap_temp.kode_dr IN (128, 162, 121))
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [v_bill_dokter_ri_fee]");
    }
};
