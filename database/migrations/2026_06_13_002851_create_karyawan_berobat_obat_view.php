...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.karyawan_berobat_obat
AS
...
HAVING      (dbo.tc_trans_pelayanan.jenis_tindakan IN (11))
ORDER BY bln
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [karyawan_berobat_obat]");
    }
};
