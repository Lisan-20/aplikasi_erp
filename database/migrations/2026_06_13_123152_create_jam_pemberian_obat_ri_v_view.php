...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.jam_pemberian_obat_ri_v
AS
SELECT     dbo.fr_far_resep_ri_dokter.id_resep_ri_dr, dbo.fr_far_resep_ri_dokter.kode_resep, dbo.fr_far_resep_ri_dokter.no_kunjungan, dbo.fr_far_resep_ri_dokter.no_registrasi, 
                      ...
                      dbo.fr_tc_far_detail.kd_tr_resep, dbo.fr_tc_far.kode_bagian_asal, dbo.mt_bagian.nama_bagian, dbo.fr_tc_far.tgl_trans, dbo.fr_tc_far_detail.kode_trans_far, dbo.fr_tc_far_detail.ttd_pasien1, 
                      dbo.fr_tc_far_detail.ttd_pasien2, dbo.fr_tc_far_detail.ttd_pasien3, dbo.fr_tc_far_detail.ttd_pasien4, dbo.fr_tc_far_detail.ttd_pasien5, dbo.fr_tc_far_detail.perawat1, dbo.fr_tc_far_detail.perawat2, 
                      dbo.fr_tc_far_detail.perawat3, dbo.fr_tc_far_detail.perawat4, dbo.fr_tc_far_detail.perawat5, dbo.fr_tc_far_detail.ttd_pasien_nama1, dbo.fr_tc_far_detail.ttd_pasien_nama2, 
                      dbo.fr_tc_far_detail.ttd_pasien_nama3, dbo.fr_tc_far_detail.ttd_pasien_nama4, dbo.fr_tc_far_detail.ttd_pasien_nama5, dbo.fr_far_resep_ri_dokter.flag_perawat
...
WHERE     (dbo.tc_registrasi.tgl_jam_keluar IS NULL) AND (dbo.tc_registrasi.status_batal IS NULL) AND (dbo.fr_far_resep_ri_dokter.flag_perawat IS NULL)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [jam_pemberian_obat_ri_v]");
    }
};
