...
return new class extends Migration
{
    ...
    {
        DB::unprepared("CREATE OR ALTER PROCEDURE [dbo].[pindah_billing_Pt_kemenkes_sp]
...
");
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS pindah_billing_Pt_kemenkes_sp");
    }
};
