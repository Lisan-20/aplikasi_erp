...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.admin_mt_tarif_view
AS
SELECT     TOP (100) PERCENT dbo.mt_master_tarif.kode_tarif, dbo.mt_master_tarif.nama_tarif, dbo.mt_master_tarif.tingkatan, dbo.mt_master_tarif.referensi, dbo.mt_master_tarif.jenis_tindakan, 
                      ...
                      dbo.mt_tarif_v.bill_dr1_inhealth, dbo.mt_tarif_v.bill_dr2_inhealth, dbo.mt_tarif_v.total_inhealth, dbo.mt_tarif_v.total_pt, dbo.mt_tarif_v.total_ass, dbo.mt_tarif_v.total_bpjs, 
                      dbo.mt_tarif_v.bill_rs_bpjs_tk, dbo.mt_tarif_v.bill_dr1_bpjs_tk, dbo.mt_tarif_v.bill_dr2_bpjs_tk, dbo.mt_tarif_v.total_bpjs_tk
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [admin_mt_tarif_view]");
    }
};
