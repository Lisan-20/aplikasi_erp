...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.sensus_gizi_detail_jenis_v
AS
SELECT     COUNT(dbo.tc_sensus_gizi_max_v.no_registrasi) AS jumlah, dbo.mt_diet_v.nama_diet
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [sensus_gizi_detail_jenis_v]");
    }
};
