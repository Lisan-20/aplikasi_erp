...
return new class extends Migration
{
    ...
    {
        DB::unprepared("CREATE OR ALTER PROCEDURE [dbo].[kirim_apotik_sp]
...
BEGIN
	BEGIN
		...
		SELECT		kode_trans_pelayanan=@MaxKd,
					no_registrasi,
					no_mr,
					...
					harga_beli,
					profit_2_persen
		FROM kirim_far_ke_transpel_v Where kd_tr_resep=@kd_tr_resep
...
END");
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS kirim_apotik_sp");
    }
};
