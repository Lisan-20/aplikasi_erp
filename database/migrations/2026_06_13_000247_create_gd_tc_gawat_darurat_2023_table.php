...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('gd_tc_gawat_darurat_2023')) {
            return;
        }

        Schema::create('gd_tc_gawat_darurat_2023', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('gd_tc_gawat_darurat_2023');
    }
};
