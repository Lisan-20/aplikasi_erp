...
return new class extends Migration
{
    ...
    {
        DB::statement("
CREATE OR ALTER VIEW dbo.fr_kinerja_obalkes_v
AS
SELECT     dbo.tc_trans_pelayanan.kode_trans_pelayanan, dbo.tc_trans_pelayanan.tgl_transaksi AS tgl_trans, 
                      ...
                      dbo.tc_trans_pelayanan.kode_profit
FROM         dbo.mt_karyawan RIGHT OUTER JOIN
                      dbo.tc_trans_pelayanan ON dbo.mt_karyawan.no_induk = dbo.tc_trans_pelayanan.kode_dokter1 LEFT OUTER JOIN
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [fr_kinerja_obalkes_v]");
    }
};
