...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.antrian_loket_poli_v
AS
SELECT     TOP (100) PERCENT b.nama_pasien, c.nama_bagian, a.kode_trans_pelayanan, a.kode_tc_trans_kasir, a.no_kunjungan, a.no_registrasi, a.no_mr, a.nama_pasien_layan, a.kode_kelompok, 
                      ...
                      THEN 0 ELSE diskon_dr2 END AS diskon_dr2, a.npp, dbo.tc_registrasi.tgl_jam_keluar, dbo.tc_registrasi.status_batal AS Expr1, dbo.tc_registrasi.kode_bagian_keluar
...
WHERE     (a.status_selesai = 2) AND (a.status_batal IS NULL) AND (a.kode_bagian LIKE '01%') AND (dbo.tc_registrasi.status_batal IS NULL)
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [antrian_loket_poli_v]");
    }
};
