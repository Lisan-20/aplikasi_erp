...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.karyawan_berobat_rad
AS
...
GROUP BY dbo.tc_trans_pelayanan.no_mr, MONTH(dbo.tc_trans_pelayanan.tgl_transaksi), YEAR(dbo.tc_trans_pelayanan.tgl_transaksi), 
                      dbo.tc_trans_pelayanan.jenis_tindakan, dbo.mt_master_pasien.nama_pasien, dbo.mt_master_pasien.nama_kel_pasien, dbo.tc_trans_pelayanan.kode_perusahaan, 
                      dbo.tc_trans_pelayanan.kode_bagian
HAVING      (dbo.tc_trans_pelayanan.jenis_tindakan IN (3)) AND (dbo.tc_trans_pelayanan.kode_bagian = '050201')
ORDER BY bln
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [karyawan_berobat_rad]");
    }
};
