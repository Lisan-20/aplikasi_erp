...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.tc_pemeriksaan_edukasi_v
AS
SELECT     dbo.tc_edukasi_terpadu_det.kode_bagian, dbo.tc_edukasi_terpadu_det.no_kunjungan, dbo.tc_edukasi_terpadu_det.kd_lev, dbo.tc_edukasi_terpadu_det.kd_type, dbo.tc_edukasi_terpadu_det.hasil, 
                      ...
                      dbo.mt_acc_erm.kd_EWS, dbo.mt_acc_erm.warna, dbo.tc_edukasi_terpadu_det.no_urut_edukasi
...
WHERE     (dbo.tc_edukasi_terpadu_det.kd_lev = 3) AND (dbo.tc_registrasi.status_batal IS NULL)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [tc_pemeriksaan_edukasi_v]");
    }
};
