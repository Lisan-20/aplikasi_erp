...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.perhitungan_bpjs_bedah_ranap_icu_vk_baru_v
AS
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [perhitungan_bpjs_bedah_ranap_icu_vk_baru_v]");
    }
};
