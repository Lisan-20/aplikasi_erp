...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.ngecek_tarif_v
AS
SELECT        TOP (100) PERCENT dbo.mt_bagian.nama_bagian, dbo.mt_klas.nama_klas, dbo.mt_master_tarif.kode_tarif, dbo.mt_master_tarif.nama_tarif, 
                         ...
                         dbo.mt_master_tarif_detail.total_ass, dbo.mt_master_tarif_detail.bill_rs_bpjs, dbo.mt_master_tarif_detail.bill_dr1_bpjs, 
                         dbo.mt_master_tarif_detail.total AS total_bpjs, dbo.mt_master_tarif_detail.bill_rs_inhealth, dbo.mt_master_tarif_detail.bill_dr1_inhealth, 
                         dbo.mt_master_tarif_detail.total_inhealth
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [ngecek_tarif_v]");
    }
};
