...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_pemeriksaan_ri_gizi_temp')) {
            return;
        }

        Schema::create('tc_pemeriksaan_ri_gizi_temp', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tc_pemeriksaan_ri_gizi_temp');
    }
};
