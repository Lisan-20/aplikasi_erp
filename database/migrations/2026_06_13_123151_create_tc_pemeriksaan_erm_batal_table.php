...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_pemeriksaan_erm_batal')) {
            return;
        }

        Schema::create('tc_pemeriksaan_erm_batal', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tc_pemeriksaan_erm_batal');
    }
};
