...
return new class extends Migration
{
    ...
    {
        DB::unprepared("CREATE OR ALTER PROCEDURE [dbo].[lap_kunjungan_unit_bln_detail2_sp]
@bulan as int,
@tahun as int,
...
from laporan_kunjungan_unit_sex_sum_v where kode_perusahaan=@kode_perusahaan and bln =@bulan and thn =@tahun;
...
from laporan_kunjungan_unit_usia_sum_v where kode_perusahaan=@kode_perusahaan and bln =@bulan and thn =@tahun;
...
");
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS lap_kunjungan_unit_bln_detail2_sp");
    }
};
