...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.hitung_omzet_rs_harian_v
AS
...
HAVING      (dbo.tc_trans_pelayanan.status_batal IS NULL) AND (dbo.tc_trans_pelayanan.kode_tc_trans_kasir > 0)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [hitung_omzet_rs_harian_v]");
    }
};
