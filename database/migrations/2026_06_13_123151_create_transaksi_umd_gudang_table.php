...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('transaksi_umd_gudang')) {
            return;
        }

        Schema::create('transaksi_umd_gudang', function (Blueprint $table) {
            ...
            $table->integer('status_terima')->nullable();

            $table->primary(['id_trans_umd'], 'pk_transaksi_umd_gudang');
        });
    }
    ...
    {
        Schema::dropIfExists('transaksi_umd_gudang');
    }
};
