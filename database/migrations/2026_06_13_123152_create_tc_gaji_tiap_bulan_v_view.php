...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.tc_gaji_tiap_bulan_v
AS
SELECT     dbo.tc_gaji_tiap_bulan.id_tc_thp, dbo.tc_gaji_tiap_bulan.id_periode_gaji, dbo.tc_gaji_tiap_bulan.periode, dbo.tc_gaji_tiap_bulan.tahun, dbo.tc_gaji_tiap_bulan.bulan, 
                      ...
                      dbo.tc_gaji_tiap_bulan.flag_final, dbo.tc_gaji_tiap_bulan.status_ver, dbo.tc_gaji_tiap_bulan.user_ver, dbo.tc_gaji_tiap_bulan.tgl_ver, dbo.mt_karyawan.no_rekening, 
                      dbo.tc_gaji_tiap_bulan.pot_indisipliner, dbo.tc_gaji_tiap_bulan.bonus_kinerja, dbo.tc_gaji_tiap_bulan.bonus_tahunan, dbo.tc_gaji_tiap_bulan.dana_pendidikan
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [tc_gaji_tiap_bulan_v]");
    }
};
