...
return new class extends Migration
{
    ...
    {
        DB::unprepared("CREATE OR ALTER PROCEDURE [dbo].[kirim_apotik_ok_sp_ulang]
...
BEGIN
	BEGIN
		...
		SELECT	@MaxKd + row_number() over(order by @MaxKd),
					...
					profit_2_persen,
					no_reg_resep
		FROM kirim_far_ke_transpel_ulang_v Where kode_trans_far=@kode_trans_far
...
END");
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS kirim_apotik_ok_sp_ulang");
    }
};
