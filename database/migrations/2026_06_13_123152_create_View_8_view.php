...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.View_8
AS
SELECT     TOP (100) PERCENT dbo.pl_tc_poli.id_pl_tc_poli, dbo.pl_tc_poli.kode_poli, dbo.pl_tc_poli.no_kunjungan, dbo.pl_tc_poli.kode_bagian, dbo.pl_tc_poli.no_antrian, dbo.pl_tc_poli.tgl_jam_poli, 
                      ...
                      dbo.mt_master_pasien.st_resum, dbo.pasien_periksa_EKG_v.no_kunjungan AS Expr2
FROM         dbo.pl_tc_poli INNER JOIN
                      ...
                      dbo.pasien_periksa_EKG_v ON dbo.tc_registrasi.no_registrasi = dbo.pasien_periksa_EKG_v.no_registrasi LEFT OUTER JOIN
                      dbo.mt_karyawan ON dbo.pl_tc_poli.kode_dokter = dbo.mt_karyawan.kode_dokter
WHERE     (dbo.tc_registrasi.status_batal IS NULL) AND (dbo.tc_kunjungan.status_batal IS NULL) AND (dbo.pl_tc_poli.kode_bagian <> '011801')
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [View_8]");
    }
};
