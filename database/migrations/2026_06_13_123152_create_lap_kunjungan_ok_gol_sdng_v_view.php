...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.lap_kunjungan_ok_gol_sdng_v
AS
...
HAVING      (mt_master_tarif_1.kode_grup_tindakan = 2)
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [lap_kunjungan_ok_gol_sdng_v]");
    }
};
