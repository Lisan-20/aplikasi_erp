...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.v_jurnal_cogs_ri_2nd
AS
SELECT     TOP (100) PERCENT dbo.tran_sed.no_registrasi, SUM(CASE WHEN dbo.tran_sed.jumlah IS NULL THEN 0 ELSE dbo.tran_sed.jumlah END) AS jumlah, 
                      ...
                      dbo.tran_sed.no_kuitansi, SUM(dbo.tran_sed.jumlah) AS jumlah_barang, dbo.tran_sed.kode_barang, dbo.tran_sed.tgl_jam AS tx_tgl, dbo.tran_sed.kode_bagian, dbo.tran_sed.kode_bagian_asal, 
...
WHERE     (dbo.tran_sed.jenis_tindakan IN (11)) AND (dbo.tran_sed.kode = 18) AND (dbo.tran_sed.tx_nominal > 0)
...
HAVING      (dbo.jurnal_billing_v.kel_jurnal = '2')
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [v_jurnal_cogs_ri_2nd]");
    }
};
