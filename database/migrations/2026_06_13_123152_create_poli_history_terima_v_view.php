...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.poli_history_terima_v
AS
SELECT        TOP (100) PERCENT dbo.pl_tc_poli.id_pl_tc_poli, dbo.pl_tc_poli.kode_poli, dbo.pl_tc_poli.no_kunjungan, dbo.pl_tc_poli.kode_bagian, dbo.pl_tc_poli.no_antrian, dbo.pl_tc_poli.tgl_jam_poli, 
                         dbo.pl_tc_poli.kode_dokter, dbo.pl_tc_poli.kode_resep, dbo.pl_tc_poli.kode_gcu, dbo.pl_tc_poli.status_periksa, dbo.pl_tc_poli.no_induk, dbo.tc_kunjungan.no_mr, dbo.mt_master_pasien.nama_pasien, 
                         dbo.mt_bagian.nama_bagian AS nama_poli, dbo.mt_karyawan.nama_pegawai AS nama_dokter, dbo.mt_master_pasien.tgl_lhr, dbo.mt_master_pasien.kode_agama, dbo.mt_master_pasien.kode_pendidikan, 
                         ...
                         dbo.pl_tc_poli.kode_bagian AS kode_bagian_poli, dbo.mt_master_pasien.almt_ttp_pasien AS alamat_pasien, dbo.mt_master_pasien.nik, dbo.tc_registrasi.umur, dbo.pl_tc_poli.kode_jadwal, 
                         dbo.tc_registrasi.kode_perusahaan, dbo.tc_registrasi.kode_kelompok, dbo.tc_registrasi.flag_status, dbo.tc_registrasi.user_trma_p2d
...
WHERE        (dbo.tc_registrasi.flag_status = 2)
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [poli_history_terima_v]");
    }
};
