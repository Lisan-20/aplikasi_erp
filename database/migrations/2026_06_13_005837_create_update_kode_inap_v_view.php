...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.update_kode_inap_v
AS
SELECT     dbo.tc_trans_kasir.kode_tc_trans_kasir, dbo.tc_trans_kasir.seri_kuitansi, dbo.tc_trans_kasir.no_kuitansi, dbo.tc_trans_kasir.no_kuitansi_bendahara, 
                      ...
                      dbo.tc_registrasi.kode_perusahaan, dbo.tc_trans_kasir.kode_inap, dbo.ri_tc_rawatinap.kode_inap AS kode_inap_upd
FROM         dbo.ri_tc_rawatinap INNER JOIN
                      ...
                      dbo.tc_registrasi ON dbo.tc_trans_kasir.no_registrasi = dbo.tc_registrasi.no_registrasi ON dbo.tc_kunjungan.no_registrasi = dbo.tc_registrasi.no_registrasi
WHERE     (dbo.tc_trans_kasir.status_batal IS NULL) AND (dbo.tc_trans_kasir.seri_kuitansi IN ('AI', 'RI', 'UM'))
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [update_kode_inap_v]");
    }
};
