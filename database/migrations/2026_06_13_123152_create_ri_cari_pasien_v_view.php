...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.ri_cari_pasien_v
AS
SELECT        dbo.mt_master_pasien.no_mr, dbo.tc_registrasi.no_registrasi, dbo.tc_kunjungan.no_kunjungan, dbo.ri_tc_rawatinap.kode_ri, dbo.mt_master_pasien.nama_pasien, dbo.ri_tc_rawatinap.kode_ruangan, 
                         ...
                         dbo.ri_tc_rawatinap.status_pulang, dbo.ri_tc_rawatinap.status_cuti, dbo.tc_registrasi.status_registrasi, dbo.tc_registrasi.kode_perusahaan, dbo.tc_registrasi.kode_kelompok, dbo.ri_tc_rawatinap.no_jkn, 
                         dbo.ri_tc_rawatinap.kode_plafon, dbo.ri_tc_rawatinap.plafon_bpjs AS plafon_old, dbo.ri_tc_rawatinap.diagnosa_awal, dbo.ri_tc_rawatinap.icd10, dbo.ri_tc_rawatinap.icd9, dbo.ri_tc_rawatinap.jatah_klas, 
                         dbo.tc_registrasi.no_jkn AS Expr1, dbo.tc_registrasi.kode_dokter, dbo.mt_karyawan.nama_pegawai, dbo.tc_kunjungan.tgl_masuk AS Expr2, dbo.tc_kunjungan.status_batal, dbo.mt_bagian.nama_bagian, dbo.mt_klas.nama_klas, 
                         dbo.tc_registrasi.umur, dbo.mt_master_pasien.almt_ttp_pasien AS alamat, dbo.ri_tc_rawatinap.catatan, dbo.tc_registrasi.noSep, dbo.tc_kunjungan.tgl_blpl, dbo.tc_registrasi.id_paket, dbo.tc_kunjungan.status_keluar, 
                         ...
                         dbo.tc_registrasi.flag_sk_pasien, dbo.tc_registrasi.ttd_sk_pasien, dbo.tc_registrasi.ttd_ri, dbo.tc_registrasi.flag_dr, dbo.tc_kunjungan.flag_serah, dbo.serah_terima_pasien_v.no_kunjungan_asal, 
                         dbo.tc_kunjungan.kode_bagian_asal, dbo.mt_bagian.kode_depo_bag, dbo.mt_karyawan.no_induk
FROM            dbo.tc_kunjungan INNER JOIN
                         ...
                         dbo.serah_terima_pasien_v ON dbo.tc_kunjungan.no_registrasi = dbo.serah_terima_pasien_v.no_registrasi LEFT OUTER JOIN
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [ri_cari_pasien_v]");
    }
};
