...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.resum_pasien_rj_v
AS
SELECT     dbo.tc_trans_kasir.seri_kuitansi, dbo.tc_trans_kasir.no_kuitansi, dbo.tc_trans_kasir.no_registrasi, dbo.tc_trans_kasir.no_mr, dbo.tc_trans_kasir.tgl_jam, dbo.tc_registrasi.kode_kelompok, 
                      ...
                      dbo.tc_registrasi.ttd, dbo.tc_registrasi.kode_bagian_masuk, YEAR(dbo.tc_trans_kasir.tgl_jam) AS Expr1, dbo.tc_trans_kasir.tgl_ver_berkas, dbo.tc_trans_kasir.flag_ver_berkas, 
                      dbo.tc_registrasi.kode_dokter, dbo.mt_karyawan.nama_pegawai AS nama_dokter, dbo.mt_bagian.nama_bagian, dbo.tc_registrasi.noRujukan
FROM         dbo.tc_trans_kasir INNER JOIN
                      ...
                      dbo.tc_emr_form_v ON dbo.tc_registrasi.no_registrasi = dbo.tc_emr_form_v.no_registrasi
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [resum_pasien_rj_v]");
    }
};
