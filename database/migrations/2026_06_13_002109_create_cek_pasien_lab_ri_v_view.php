...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.cek_pasien_lab_ri_v
AS
...
WHERE     (paket_sectio IS NULL) AND (kode_bagian = '050101') AND (kode_bagian_asal LIKE '03%') AND (status_selesai < 3)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [cek_pasien_lab_ri_v]");
    }
};
