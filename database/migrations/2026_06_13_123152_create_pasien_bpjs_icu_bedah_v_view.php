...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.pasien_bpjs_icu_bedah_v
AS
...
WHERE     (dbo.tc_trans_pelayanan.no_registrasi IN
                          (SELECT     no_registrasi
                            ...
                            WHERE      (kode_bagian_tujuan = 031001) OR
                                                   (kode_bagian_tujuan IN (030501, 030901)))) AND (dbo.tc_registrasi.tgl_jam_keluar IS NOT NULL) AND (dbo.tc_trans_pelayanan.kode_kelompok IN (8, 9, 
                      10, 11, 12))
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [pasien_bpjs_icu_bedah_v]");
    }
};
