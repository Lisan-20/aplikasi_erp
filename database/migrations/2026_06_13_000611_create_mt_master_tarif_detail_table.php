...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('mt_master_tarif_detail')) {
            return;
        }
        ...
        Schema::create('mt_master_tarif_detail', function (Blueprint $table) {
            ...
            $table->integer('bill_rs_bpjs_tk')->nullable();
            $table->integer('bill_dr1_bpjs_tk')->nullable();
            $table->integer('bill_dr2_bpjs_tk')->nullable();
            $table->integer('total_bpjs_tk')->nullable();

            $table->primary(['kode_master_tarif_detail'], 'pk_mt_master_tarif_detail_ok2');
        });
    }
