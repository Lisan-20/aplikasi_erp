...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.inp_fee_dr1_bpjs_rad_RJ_v
AS
...
WHERE     (dbo.tc_registrasi.kode_kelompok IN (9, 10)) AND (dbo.tc_trans_pelayanan.flag_dr1 IS NULL OR
                      ...
                      (dbo.tc_trans_pelayanan.kode_dokter1 > 0) AND (dbo.tc_trans_pelayanan.status_batal IS NULL) AND (dbo.tc_trans_pelayanan.kode_bagian = '050201') AND 
                      (dbo.tc_trans_kasir.seri_kuitansi IN ('AJ', 'RJ', 'NK'))
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [inp_fee_dr1_bpjs_rad_RJ_v]");
    }
};
