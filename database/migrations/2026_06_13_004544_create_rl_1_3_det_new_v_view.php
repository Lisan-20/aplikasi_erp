...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.rl_1_3_det_new_v
AS
SELECT     dbo.mt_bagian.nama_bagian AS tujuan, dbo.ri_tc_riwayat_kelas.bagian_asal, COUNT(dbo.tc_registrasi.no_registrasi) AS jml_pasien, YEAR(dbo.tc_registrasi.tgl_jam_masuk) AS thn, 
                      dbo.ri_tc_riwayat_kelas.kelas_tujuan
...
GROUP BY YEAR(dbo.tc_registrasi.tgl_jam_masuk), dbo.mt_bagian.nama_bagian, dbo.ri_tc_riwayat_kelas.bagian_asal, dbo.ri_tc_riwayat_kelas.kelas_tujuan
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [rl_1_3_det_new_v]");
    }
};
