...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.laporan_all_shift_bpjs_2_v
AS
SELECT     dbo.tc_registrasi.kode_kelompok, dbo.tc_trans_kasir.seri_kuitansi, dbo.tc_trans_kasir.tgl_jam, dbo.tc_trans_kasir.no_registrasi, dbo.tc_trans_kasir.bill, dbo.tc_trans_kasir.nk_perusahaan, 
                      ...
                      dbo.tc_registrasi.id_dc_asal_pasien, dbo.tc_registrasi.tgl_jam_keluar, dbo.tc_registrasi.no_jaminan, dbo.tc_registrasi.kode_bagian_masuk
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [laporan_all_shift_bpjs_2_v]");
    }
};
