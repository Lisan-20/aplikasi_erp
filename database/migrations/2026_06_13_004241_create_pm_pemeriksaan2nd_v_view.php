...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.pm_pemeriksaan2nd_v
AS
SELECT     dbo.pm_pasienpm_v.status_daftar, dbo.pm_pasienpm_v.jen_kelamin, dbo.pm_pasienpm_v.catatan_hasil, dbo.pm_pasienpm_v.nama_pasien, 
                      ...
                      dbo.tc_trans_pelayanan.no_mr, dbo.tc_trans_pelayanan.nama_pasien_layan, dbo.tc_trans_pelayanan.kode_kelompok, 
                      ...
                      dbo.tc_trans_pelayanan.kode_penunjang, dbo.tc_trans_pelayanan.status_selesai, dbo.tc_trans_pelayanan.status_nk, 
                      dbo.pm_pasienpm_v.dr_pengirim, dbo.pm_pasienpm_v.no_registrasi
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [pm_pemeriksaan2nd_v]");
    }
};
