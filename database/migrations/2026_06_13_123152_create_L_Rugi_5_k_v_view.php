...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.L_Rugi_5_k_v
AS
...
GROUP BY dbo.tx_harian.acc_no, MONTH(dbo.tx_harian.tx_tgl), YEAR(dbo.tx_harian.tx_tgl), dbo.tx_harian.tx_tipe, dbo.mt_account.referensi
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [L_Rugi_5_k_v]");
    }
};
