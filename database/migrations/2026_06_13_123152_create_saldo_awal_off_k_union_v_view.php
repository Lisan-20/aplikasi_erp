...
SELECT     dbo.bd_tc_trans_union_v.acc_no, dbo.bd_tc_trans_union_v.tx_tipe, MIN(DISTINCT dbo.bd_tc_trans_union_v.jumlah) AS saldo_awal, 
                      ...
                      dbo.Bank_v.id_bank, dbo.Bank_v.Kas_Bank, dbo.Bank_v.acc_nama, dbo.bd_tc_trans_union_v.kode_bagian, dbo.bd_tc_trans_union_v.tgl_transaksi, 
...
GROUP BY dbo.bd_tc_trans_union_v.acc_no, dbo.bd_tc_trans_union_v.tx_tipe, DAY(dbo.bd_tc_trans_union_v.tgl_transaksi), YEAR(dbo.bd_tc_trans_union_v.tgl_transaksi), 
                      MONTH(dbo.bd_tc_trans_union_v.tgl_transaksi), dbo.Bank_v.id_bank, dbo.Bank_v.Kas_Bank, dbo.Bank_v.acc_nama, dbo.bd_tc_trans_union_v.kode_bagian, 
                      dbo.bd_tc_trans_union_v.tgl_transaksi, dbo.bd_tc_trans_union_v.id_bd_tc_trans
HAVING      (dbo.bd_tc_trans_union_v.tx_tipe = '1')
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [saldo_awal_off_k_union_v]");
    }
};
