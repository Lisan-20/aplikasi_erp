...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.v_dr_lab_bpjs
AS
...
WHERE     (dbo.tc_trans_pelayanan.kode_kelompok IN (9, 8)) AND (dbo.tc_trans_pelayanan.flag_dr_lab IS NULL) AND (dbo.tc_trans_pelayanan.kode_bagian = '050101') AND 
                      (NOT (dbo.tc_trans_pelayanan.nama_tindakan LIKE 'admin%')) AND (dbo.tc_trans_pelayanan.bill_dr1 > 0) AND 
                      ((dbo.tc_trans_pelayanan.bill_dr1 + dbo.tc_trans_pelayanan.bill_rs) * 1 / 100 > 0)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [v_dr_lab_bpjs]");
    }
};
