...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.v_trans_adm_pt_RJ_v
AS
...
WHERE     (dbo.tc_trans_pelayanan.flag_jurnal = 0) AND (dbo.tc_trans_kasir.status_batal IS NULL) AND (dbo.tc_trans_pelayanan.jenis_tindakan IN (2)) AND 
                      ...
                      dbo.mt_perusahaan.flag IS NULL) AND (dbo.tc_trans_pelayanan.status_batal IS NULL)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [v_trans_adm_pt_RJ_v]");
    }
};
