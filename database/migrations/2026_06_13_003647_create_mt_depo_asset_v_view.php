...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.mt_depo_asset_v
AS
SELECT     dbo.mt_asset.id_asset, dbo.mt_asset.kode_bagian, dbo.mt_asset.asset_type, dbo.mt_asset.tgl_perolehan, dbo.mt_asset.tgl_pemakaian, dbo.mt_asset.qty, dbo.mt_asset.estimasi_penggunaan, 
                      ...
                      dbo.mt_tipe_asset.nama_tipe, dbo.mt_barang_nm.nama_brg, dbo.mt_barang_nm.kode_brg, dbo.mt_barang_nm.satuan_kecil, dbo.mt_barang_nm.harga_beli, dbo.mt_barang_nm.satuan_besar, 
...
FROM         dbo.mt_asset INNER JOIN
                      ...
                      dbo.mt_barang_nm ON dbo.mt_asset.kode_brg = dbo.mt_barang_nm.kode_brg CROSS JOIN
                      dbo.tbl_proses_penyusutan
WHERE     (dbo.mt_barang_nm.harga_beli >= 1000000) AND (dbo.tbl_proses_penyusutan.flag IS NULL)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [mt_depo_asset_v]");
    }
};
