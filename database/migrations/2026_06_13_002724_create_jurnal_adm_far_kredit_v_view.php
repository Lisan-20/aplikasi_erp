...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.jurnal_adm_far_kredit_v
AS
...
WHERE     (dbo.mapping_transaksi_rs_v.kode_proses = 2) AND (dbo.tc_trans_kasir.seri_kuitansi = 'RJ' OR
                      ...
                      (dbo.mapping_transaksi_rs_v.kode_jenis_proses = 9) AND (dbo.tc_trans_pelayanan.status_kredit = 1) AND (dbo.mapping_transaksi_rs_v.acc_debet > 0)
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [jurnal_adm_far_kredit_v]");
    }
};
