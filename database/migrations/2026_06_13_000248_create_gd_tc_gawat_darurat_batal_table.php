...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('gd_tc_gawat_darurat_batal')) {
            return;
        }

        Schema::create('gd_tc_gawat_darurat_batal', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('gd_tc_gawat_darurat_batal');
    }
};
