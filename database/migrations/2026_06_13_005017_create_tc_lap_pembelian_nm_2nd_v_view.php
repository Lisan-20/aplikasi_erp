...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.tc_lap_pembelian_nm_2nd_v
AS
SELECT     dbo.mt_barang_jasa.nama_brg, dbo.mt_barang_jasa.kode_brg, dbo.mt_barang_jasa.satuan_besar, dbo.tc_permohonan_nm.kode_permohonan, dbo.mt_barang_jasa.type, 
                      dbo.mt_barang_jasa.merk, dbo.mt_barang_jasa.buatan, dbo.tc_penerimaan_barang_nm_detail.jumlah_pesan, dbo.tc_penerimaan_barang_nm_detail.jumlah_kirim, 
...
FROM         dbo.mt_barang_jasa INNER JOIN
                      ...
                      dbo.mt_barang_jasa.kode_brg = dbo.tc_po_nm_det.kode_brg INNER JOIN
                      ...
                      dbo.mt_pabrik_nm ON dbo.mt_barang_jasa.kode_pabrik = dbo.mt_pabrik_nm.kode_pabrik
");
    }
