...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.cek_KB_kredit
AS
...
HAVING      (dbo.bd_tc_trans_detail.tx_tipe = 0) AND (dbo.bd_tc_trans_detail.tgl_ver IS NULL) AND (dbo.bd_tc_trans_detail.flag_jurnal = 0) AND 
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [cek_KB_kredit]");
    }
};
