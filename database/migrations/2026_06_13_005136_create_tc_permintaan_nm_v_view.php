...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.tc_permintaan_nm_v
AS
SELECT     dbo.tc_permintaan_inst_nm.id_tc_permintaan_inst, dbo.tc_permintaan_inst_nm_det.id_tc_permintaan_inst_det, 
                      ...
                      dbo.mt_barang_jasa.nama_brg, dbo.tc_permintaan_inst_nm_det.jumlah_permintaan, dbo.mt_barang_jasa.satuan_kecil, 
...
FROM         dbo.tc_permintaan_inst_nm INNER JOIN
                      ...
                      dbo.mt_barang_jasa ON dbo.tc_permintaan_inst_nm_det.kode_brg = dbo.mt_barang_jasa.kode_brg INNER JOIN
