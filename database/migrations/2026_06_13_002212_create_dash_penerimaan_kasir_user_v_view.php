...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.dash_penerimaan_kasir_user_v
AS
SELECT     dbo.tc_trans_kasir.status_batal, CASE WHEN tunai IS NULL THEN 0 ELSE tunai END AS tunai, CASE WHEN debet IS NULL THEN 0 ELSE debet END AS debet, 
                      ...
                      dbo.tc_trans_kasir.no_induk, dbo.mt_karyawan.nama_pegawai
FROM         dbo.tc_trans_kasir LEFT OUTER JOIN
                      dbo.mt_karyawan ON dbo.tc_trans_kasir.no_induk = dbo.mt_karyawan.no_induk
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [dash_penerimaan_kasir_user_v]");
    }
};
