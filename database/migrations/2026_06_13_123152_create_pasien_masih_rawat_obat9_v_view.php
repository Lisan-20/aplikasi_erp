...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.pasien_masih_rawat_obat9_v
AS
SELECT     dbo.fr_far_resep_ri_display.id, dbo.fr_far_resep_ri_display.kode_brg, dbo.pasien_masih_rawat_obat2_v.jumlah, dbo.pasien_masih_rawat_obat2_v.bag_pas, 
                      dbo.fr_far_resep_ri_display.jml_bag6
...
WHERE     (dbo.pasien_masih_rawat_obat2_v.bag_pas = '030501')
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [pasien_masih_rawat_obat9_v]");
    }
};
