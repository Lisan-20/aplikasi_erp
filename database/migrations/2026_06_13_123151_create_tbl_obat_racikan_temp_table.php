...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tbl_obat_racikan_temp')) {
            return;
        }

        Schema::create('tbl_obat_racikan_temp', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('kode_brg_racikan', 50)->nullable();
            ...
            $table->char('jumlah_dtd', 10)->nullable();
            $table->integer('id_resep_ri_dr')->nullable();
            $table->text('catatan')->nullable();

            $table->primary(['id'], 'pk_tbl_obat_racikan_temp');
        });
    }
    ...
    {
        Schema::dropIfExists('tbl_obat_racikan_temp');
    }
};
