...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_trans_pelayanan_temp')) {
            return;
        }

        Schema::create('tc_trans_pelayanan_temp', function (Blueprint $table) {
            ...
            $table->integer('no_reg_resep_old')->nullable();
            ...
            $table->bigInteger('no_reg_resep')->nullable();
        });
    }
    ...
    {
        Schema::dropIfExists('tc_trans_pelayanan_temp');
    }
};
