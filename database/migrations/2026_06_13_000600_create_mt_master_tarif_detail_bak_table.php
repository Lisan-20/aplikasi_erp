...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('mt_master_tarif_detail_bak')) {
            return;
        }

        Schema::create('mt_master_tarif_detail_bak', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mt_master_tarif_detail_bak');
    }
};
