...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.jurnal_SED_RI_ruangan_v
AS
...
FROM         dbo.bill_sed_ri_v INNER JOIN
                      ...
                      dbo.bill_sed_ri_v.kode_bagian = dbo.mapping_transaksi_rs_v.kode_bagian
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [jurnal_SED_RI_ruangan_v]");
    }
};
