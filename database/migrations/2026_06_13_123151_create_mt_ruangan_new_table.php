...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('mt_ruangan_new')) {
            return;
        }

        Schema::create('mt_ruangan_new', function (Blueprint $table) {
            ...
            $table->primary(['kode_ruangan'], 'pk_mt_ruangan_baru');
        });
    }
    ...
    {
        Schema::dropIfExists('mt_ruangan_new');
    }
};
