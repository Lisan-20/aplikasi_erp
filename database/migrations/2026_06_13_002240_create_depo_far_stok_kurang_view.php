...
WHERE     (dbo.mt_depo_stok.kode_bagian = '060101') AND (dbo.mt_depo_stok.jml_sat_kcl < dbo.mt_depo_stok.stok_minimum)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [depo_far_stok_kurang]");
    }
};
