...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_trans_pelayanan_2023')) {
            return;
        }

        Schema::create('tc_trans_pelayanan_2023', function (Blueprint $table) {
            ...
            $table->decimal('bill_dr1', 19, 4)->nullable()->default(0);
            $table->decimal('bill_dr2', 19, 4)->nullable()->default(0);
            $table->decimal('bill_dr3', 19, 4)->nullable();
            $table->decimal('bill_rs_askes', 19, 4)->nullable()->default(0);
            $table->decimal('bill_dr1_askes', 19, 4)->nullable()->default(0);
            $table->decimal('bill_dr2_askes', 19, 4)->nullable()->default(0);
            $table->decimal('bill_rs_jatah', 19, 4)->nullable()->default(0);
            $table->decimal('bill_dr1_jatah', 19, 4)->nullable()->default(0);
            $table->decimal('bill_dr2_jatah', 19, 4)->nullable()->default(0);
            $table->decimal('lain_lain', 19, 4)->nullable()->default(0);
            $table->string('kode_dokter1', 20)->nullable();
            $table->string('kode_dokter2', 20)->nullable();
            $table->string('kode_dokter3', 20)->nullable();
            $table->decimal('jumlah', 19, 4)->nullable()->default(0);
    ...
    {
        Schema::dropIfExists('tc_trans_pelayanan_2023');
    }
};
