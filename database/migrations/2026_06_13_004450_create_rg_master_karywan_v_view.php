...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.rg_master_karywan_v
AS
SELECT     dbo.mt_master_pasien.id_mt_master_pasien, dbo.mt_master_pasien.no_mr, dbo.mt_master_pasien.hubungan, dbo.mt_master_pasien.no_urutan, dbo.mt_master_pasien.kode_login, 
                      ...
                      dbo.mt_pt_asuransi.nama_pt, dbo.mt_karyawan.no_induk, dbo.mt_karyawan.nama_pegawai, dbo.mt_karyawan.kode_bagian, dbo.mt_karyawan.npp
FROM         dbo.mt_master_pasien INNER JOIN
                      dbo.mt_nasabah ON dbo.mt_master_pasien.kode_kelompok = dbo.mt_nasabah.kode_kelompok RIGHT OUTER JOIN
                      dbo.mt_karyawan ON dbo.mt_master_pasien.no_mr = dbo.mt_karyawan.no_mr LEFT OUTER JOIN
...
WHERE     (dbo.mt_karyawan.no_induk <> 1)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [rg_master_karywan_v]");
    }
};
