...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.lap_rl3_vk_v
AS
...
HAVING      (dbo.mt_master_tarif.tingkatan > 3) AND (dbo.mt_master_tarif.referensi = 305010100) AND (dbo.tc_trans_kasir.status_batal IS NULL) AND (YEAR(dbo.tc_trans_kasir.tgl_jam) = 2023)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [lap_rl3_vk_v]");
    }
};
