...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.mt_icd_diagnosa_ri_v
AS
...
FROM         dbo.mt_icd_diagnosa INNER JOIN
                      dbo.mt_icd_inacbg_diagnosa_v ON dbo.mt_icd_diagnosa.kode_icd = dbo.mt_icd_inacbg_diagnosa_v.icd_x
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [mt_icd_diagnosa_ri_v]");
    }
};
