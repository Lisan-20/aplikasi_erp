...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.jurnal_rawat_jalan_far_kredit_ass_v
AS
...
WHERE     (dbo.mapping_transaksi_rs_v.kode_proses = 2) AND (dbo.tc_trans_kasir.seri_kuitansi = 'AJ') AND (dbo.tc_trans_pelayanan.kode_barang IS NOT NULL) AND 
                      (dbo.tc_trans_pelayanan.flag_jurnal = 0) AND (dbo.tc_trans_kasir.status_batal IS NULL) AND (dbo.tc_trans_pelayanan.status_kredit = 1) AND 
                      (dbo.mapping_transaksi_rs_v.acc_debet > 0)
GROUP BY dbo.tc_trans_pelayanan.kode_tc_trans_kasir, dbo.tc_trans_pelayanan.no_registrasi, dbo.tc_trans_pelayanan.no_mr, dbo.tc_trans_pelayanan.jenis_tindakan, 
                      ...
                      dbo.tc_registrasi.kode_perusahaan, dbo.tc_registrasi.kode_kelompok, dbo.tc_trans_pelayanan.jumlah, dbo.tc_trans_pelayanan.status_kredit
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [jurnal_rawat_jalan_far_kredit_ass_v]");
    }
};
