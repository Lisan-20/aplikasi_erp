...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE VIEW dbo.penerimaan_barang_nm_v
AS
SELECT     dbo.tc_penerimaan_barang_nm.kode_penerimaan, dbo.tc_penerimaan_barang_nm.no_po, dbo.tc_penerimaan_barang_nm.tgl_penerimaan, 
                      ...
                      dbo.tc_penerimaan_barang_nm_detail.kode_brg, dbo.tc_penerimaan_barang_nm.kodesupplier, dbo.mt_barang_nm.nama_brg, 
                      dbo.tc_penerimaan_barang_nm_detail.tgl_ver, dbo.tc_penerimaan_barang_nm_detail.status_ver, 
                      dbo.tc_penerimaan_barang_nm_detail.kode_detail_penerimaan_barang, dbo.mt_barang_nm.kode_golongan
FROM         dbo.mt_barang_nm RIGHT OUTER JOIN
                      ...
                      dbo.mt_barang_nm.kode_brg = dbo.tc_po_nm_det.kode_brg
");
    }
