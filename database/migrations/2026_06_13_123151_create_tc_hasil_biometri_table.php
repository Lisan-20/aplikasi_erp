...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_hasil_biometri')) {
            return;
        }

        Schema::create('tc_hasil_biometri', function (Blueprint $table) {
            $table->bigIncrements('id_biometri');
    ...
    {
        Schema::dropIfExists('tc_hasil_biometri');
    }
};
