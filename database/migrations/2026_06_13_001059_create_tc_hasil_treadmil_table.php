...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_hasil_treadmil')) {
            return;
        }

        Schema::create('tc_hasil_treadmil', function (Blueprint $table) {
            $table->bigIncrements('id_treadmil');
    ...
    {
        Schema::dropIfExists('tc_hasil_treadmil');
    }
};
