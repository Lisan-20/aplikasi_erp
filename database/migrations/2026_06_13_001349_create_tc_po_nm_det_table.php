...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_po_nm_det')) {
            return;
        }

        Schema::create('tc_po_nm_det', function (Blueprint $table) {
            $table->increments('id_tc_po_det');
            ...
            $table->decimal('bonus_besar', 18, 0)->nullable();
            $table->decimal('bonus_kecil', 18, 0)->nullable();
            ...
            $table->decimal('jumlah_besar_acc', 19, 4)->nullable();
            $table->decimal('jumlah_besar_acc_dir', 19, 4)->nullable();
        });
    }
    ...
    {
        Schema::dropIfExists('tc_po_nm_det');
    }
};
