...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.jurnal_um_batal_v
AS
...
WHERE     (dbo.tx_harian.kel_jurnal = 3) AND (YEAR(dbo.tx_harian.tx_tgl) = 2014)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [jurnal_um_batal_v]");
    }
};
