...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('mt_master_tarif_detail_lab')) {
            return;
        }

        Schema::create('mt_master_tarif_detail_lab', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mt_master_tarif_detail_lab');
    }
};
