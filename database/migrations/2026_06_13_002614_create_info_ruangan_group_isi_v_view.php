...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.info_ruangan_group_isi_v
AS
...
GROUP BY dbo.mt_klas.nama_klas, dbo.mt_ruangan.status, dbo.mt_ruangan.kode_klas, dbo.mt_ruangan.kode_bagian, dbo.mt_bagian.nama_bagian, dbo.mt_ruangan.kode_ruangan
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [info_ruangan_group_isi_v]");
    }
};
