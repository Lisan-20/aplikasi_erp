...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('hsl_angket_ri')) {
            return;
        }

        Schema::create('hsl_angket_ri', function (Blueprint $table) {
            $table->increments('id');
            $table->text('nama')->nullable();
            $table->text('nama_asuransi')->nullable();
            $table->integer('no_tlp')->nullable();
            $table->text('ruang_rawat')->nullable();
    ...
    {
        Schema::dropIfExists('hsl_angket_ri');
    }
};
