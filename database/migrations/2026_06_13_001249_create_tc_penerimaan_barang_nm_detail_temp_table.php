...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_penerimaan_barang_nm_detail_temp')) {
            return;
        }

        Schema::create('tc_penerimaan_barang_nm_detail_temp', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tc_penerimaan_barang_nm_detail_temp');
    }
};
