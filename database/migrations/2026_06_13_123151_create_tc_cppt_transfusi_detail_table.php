...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_cppt_transfusi_detail')) {
            return;
        }

        Schema::create('tc_cppt_transfusi_detail', function (Blueprint $table) {
            ...
            $table->integer('hasil_1')->nullable();
            $table->integer('hasil_2')->nullable();
            $table->integer('hasil_3')->nullable();
            $table->integer('hasil_4')->nullable();
            $table->integer('kd_kk')->nullable();
            $table->string('no_registrasi', 50)->nullable();
            $table->string('no_mr', 50)->nullable();
            $table->integer('no_urut_Id')->nullable();
    ...
    {
        Schema::dropIfExists('tc_cppt_transfusi_detail');
    }
};
