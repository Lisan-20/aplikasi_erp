...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.mt_tarif_klas2_v
AS
...
WHERE     (dbo.mt_master_tarif_detail.kode_klas = 2) AND (dbo.tc_trans_pelayanan.kode_tc_trans_kasir IS NULL OR
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [mt_tarif_klas2_v]");
    }
};
