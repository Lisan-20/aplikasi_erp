...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.update_sep_rj_v
AS
...
FROM            dbo.sep_rj_manual_v INNER JOIN
                         ...
                         dbo.sep_rj_manual_v.no_mr = dbo.grouper_inacbgs_v.no_mr
WHERE        (dbo.sep_rj_manual_v.noSep IS NULL)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [update_sep_rj_v]");
    }
};
