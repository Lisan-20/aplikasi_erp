...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.jumlah_bill_1_v
AS
SELECT     dbo.tc_trans_pelayanan.no_registrasi, dbo.tc_trans_pelayanan.no_kunjungan, dbo.tc_trans_pelayanan.kode_bagian, dbo.mt_bagian.nama_bagian, SUM(CASE WHEN bill_rs IS NULL 
                      ...
                      THEN 0 ELSE diskon_dr1 END) + SUM(CASE WHEN diskon_dr2 IS NULL THEN 0 ELSE diskon_dr2 END)) AS bill_total, 0 AS bill_total_retur, dbo.tc_trans_pelayanan.kode_trans_far
...
HAVING      (dbo.tc_trans_pelayanan.status_batal IS NULL) AND (dbo.tc_trans_pelayanan.status_kredit = 0)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [jumlah_bill_1_v]");
    }
};
