...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.inp_fee_dr_bedah_mata_bpjs_v
AS
...
WHERE     (dbo.tc_registrasi.kode_kelompok = 9) AND (dbo.tc_trans_pelayanan.flag_dr1 IS NULL OR
                      ...
                      (dbo.tc_trans_pelayanan.kode_dokter1 > 0) AND (dbo.tc_trans_pelayanan.status_batal IS NULL) AND (dbo.tc_trans_pelayanan.kode_dokter1 = 232)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [inp_fee_dr_bedah_mata_bpjs_v]");
    }
};
