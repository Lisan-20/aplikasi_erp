...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.lap_dokter_harian2_v
AS
SELECT     DAY(dbo.tc_kunjungan.tgl_masuk) AS tgl, MONTH(dbo.tc_kunjungan.tgl_masuk) AS bln, YEAR(dbo.tc_kunjungan.tgl_masuk) AS thn, dbo.tc_kunjungan.no_kunjungan, 
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [lap_dokter_harian2_v]");
    }
};
