...
AS
SELECT     dbo.tc_permintaan_inst_nm.kode_bagian_minta, dbo.tc_permintaan_inst_nm.kode_bagian_kirim, dbo.mt_bagian.nama_bagian AS bagian_minta, dbo.mt_barang_jasa.nama_brg, 
...
FROM         dbo.tc_permintaan_inst_nm_det INNER JOIN
                      ...
                      dbo.mt_barang_jasa ON dbo.tc_permintaan_inst_nm_det.kode_brg = dbo.mt_barang_jasa.kode_brg
");
    }
