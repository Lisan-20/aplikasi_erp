...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_trans_pelayanan_batal')) {
            return;
        }

        Schema::create('tc_trans_pelayanan_batal', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tc_trans_pelayanan_batal');
    }
};
