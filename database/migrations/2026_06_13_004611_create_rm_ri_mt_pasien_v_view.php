...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.rm_ri_mt_pasien_v
AS
SELECT     TOP (100) PERCENT dbo.mt_master_pasien.nama_pasien, dbo.mt_master_pasien.tgl_lhr, dbo.mt_master_pasien.kode_agama, 
                      ...
                      dbo.th_icd10_pasien.no_kunjungan AS kunjung, dbo.tc_kunjungan.kode_dokter
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [rm_ri_mt_pasien_v]");
    }
};
