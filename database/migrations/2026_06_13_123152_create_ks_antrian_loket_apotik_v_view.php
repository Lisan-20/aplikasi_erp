...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.ks_antrian_loket_apotik_v
AS
SELECT     TOP (100) PERCENT b.nama_pasien, c.nama_bagian, a.kode_trans_pelayanan, a.kode_tc_trans_kasir, a.no_kunjungan, a.no_registrasi, a.no_mr, a.nama_pasien_layan, a.kode_kelompok, 
                      ...
                      THEN 0 ELSE diskon_dr2 END AS diskon_dr2, a.npp
...
WHERE     (a.status_selesai = 2) AND (a.status_batal IS NULL) AND (a.kode_tc_trans_kasir IS NULL OR
                      a.kode_tc_trans_kasir = 0)
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [ks_antrian_loket_apotik_v]");
    }
};
