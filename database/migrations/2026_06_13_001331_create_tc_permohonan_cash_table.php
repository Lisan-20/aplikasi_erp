...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_permohonan_cash')) {
            return;
        }

        Schema::create('tc_permohonan_cash', function (Blueprint $table) {
            ...
            $table->decimal('biaya_transport', 18)->nullable();
            $table->integer('flag_asal')->nullable();
            $table->integer('periodik_umum')->nullable();
            $table->char('kode_bagian', 10)->nullable();
    ...
    {
        Schema::dropIfExists('tc_permohonan_cash');
    }
};
