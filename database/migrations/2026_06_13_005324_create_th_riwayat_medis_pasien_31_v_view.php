...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.th_riwayat_medis_pasien_31_v
AS
SELECT     dbo.tc_emr_form.no_mr, dbo.tc_emr_form.tgl_update AS tgl_jam, dbo.tc_emr_form.id_user_imp AS kode_dokter, mt_karyawan_1.nama_pegawai, 1 AS st_ass, 
                      dbo.mt_karyawan.nama_pegawai AS nama_perawat, 31 AS flag, dbo.tc_emr_form.no_registrasi
...
WHERE     (dbo.tc_emr_form.kode_rm = 159)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [th_riwayat_medis_pasien_31_v]");
    }
};
