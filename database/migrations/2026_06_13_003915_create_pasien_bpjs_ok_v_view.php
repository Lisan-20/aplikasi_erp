...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.pasien_bpjs_ok_v
AS
...
WHERE     (dbo.tc_trans_pelayanan.no_registrasi IN
                          (SELECT     no_registrasi
                            FROM          dbo.pasien_ok_v)) AND (dbo.tc_registrasi.tgl_jam_keluar IS NOT NULL) AND (dbo.tc_trans_pelayanan.kode_kelompok IN (8, 9, 10, 11, 12))
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [pasien_bpjs_ok_v]");
    }
};
