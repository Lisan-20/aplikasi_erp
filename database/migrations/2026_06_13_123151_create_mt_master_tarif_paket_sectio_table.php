...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('mt_master_tarif_paket_sectio')) {
            return;
        }

        Schema::create('mt_master_tarif_paket_sectio', function (Blueprint $table) {
            ...
            $table->string('kelas_paket', 50)->nullable();
    ...
    {
        Schema::dropIfExists('mt_master_tarif_paket_sectio');
    }
};
