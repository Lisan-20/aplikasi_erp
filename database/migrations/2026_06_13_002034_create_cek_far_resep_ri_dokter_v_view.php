...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.cek_far_resep_ri_dokter_v
AS
...
WHERE     (dbo.fr_tc_far.status_transaksi = 1) AND (dbo.fr_far_resep_ri_dokter.flag_perawat IS NULL)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [cek_far_resep_ri_dokter_v]");
    }
};
