...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('transaksi_sppu')) {
            return;
        }

        Schema::create('transaksi_sppu', function (Blueprint $table) {
            $table->integer('id_trans_sppu');
            ...
            $table->decimal('per_jumlah', 19, 4)->nullable();
            $table->integer('stat_ver')->nullable();
            $table->string('dibayar_kpd', 50)->nullable();
    ...
    {
        Schema::dropIfExists('transaksi_sppu');
    }
};
