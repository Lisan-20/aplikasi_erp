...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_pemeriksaan_askep_temp')) {
            return;
        }

        Schema::create('tc_pemeriksaan_askep_temp', function (Blueprint $table) {
            ...
            $table->string('ket_hasil', 50)->nullable();
            $table->string('no_registrasi', 250)->nullable()->index('ix_no_registrasi');
        });
    }
    ...
    {
        Schema::dropIfExists('tc_pemeriksaan_askep_temp');
    }
};
