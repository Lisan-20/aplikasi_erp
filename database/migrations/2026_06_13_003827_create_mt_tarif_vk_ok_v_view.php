...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.mt_tarif_vk_ok_v
AS
SELECT     dbo.mt_master_tarif.kode_tarif, dbo.mt_master_tarif.kode_tindakan, dbo.mt_master_tarif.tingkatan, dbo.mt_master_tarif.ket, SUM(dbo.mt_master_tarif_detail_bedah.bill_rs) AS bill_rs, 
                      ...
                      dbo.mt_master_tarif_detail_bedah.kamar_tindakan, dbo.mt_master_tarif_detail_bedah.keterangan, dbo.mt_master_tarif_detail_bedah.kode_klas, dbo.tarif_bedah_level3_vk_v.nama_tarif AS bagian, 
                      dbo.tarif_bedah_level4_vk_v.nama_tarif AS jenis_operasi, dbo.mt_master_tarif.nama_tarif AS nama_operasi, dbo.mt_klas.nama_klas, dbo.mt_master_tarif_detail_bedah.bill_dr1_bpjs, 
...
FROM         dbo.mt_master_tarif INNER JOIN
                      ...
                      dbo.tarif_bedah_level5_vk_v ON dbo.mt_master_tarif_detail_bedah.kode_tarif = dbo.tarif_bedah_level5_vk_v.kode_tarif INNER JOIN
                      dbo.tarif_bedah_level4_vk_v ON dbo.tarif_bedah_level5_vk_v.referensi = dbo.tarif_bedah_level4_vk_v.kode_tarif INNER JOIN
                      dbo.tarif_bedah_level3_vk_v ON dbo.tarif_bedah_level4_vk_v.referensi = dbo.tarif_bedah_level3_vk_v.kode_tarif
WHERE     (dbo.mt_master_tarif.kode_bagian = '030501')
GROUP BY dbo.mt_master_tarif.kode_tarif, dbo.mt_master_tarif.kode_tindakan, dbo.mt_master_tarif.nama_tarif, dbo.mt_master_tarif.tingkatan, dbo.mt_master_tarif.ket, 
                      ...
                      dbo.tarif_bedah_level4_vk_v.nama_tarif, dbo.tarif_bedah_level3_vk_v.nama_tarif, dbo.mt_master_tarif_detail_bedah.bill_dr1_bpjs, dbo.mt_master_tarif_detail_bedah.bill_rs_bpjs, 
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [mt_tarif_vk_ok_v]");
    }
};
