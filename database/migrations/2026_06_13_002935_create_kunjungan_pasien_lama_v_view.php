...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.kunjungan_pasien_lama_v
AS
...
HAVING      (YEAR(dbo.lap_kunjungan_pasien_v.tgl_jam_masuk) >= 2016) AND (dbo.lap_kunjungan_pasien_v.kode_bagian_tujuan IS NOT NULL) AND 
                      (dbo.lap_kunjungan_pasien_v.stat_pasien = 'Lama')
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [kunjungan_pasien_lama_v]");
    }
};
