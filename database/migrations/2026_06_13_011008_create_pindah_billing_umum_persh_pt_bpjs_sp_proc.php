...
return new class extends Migration
{
    ...
    {
        DB::unprepared("CREATE OR ALTER PROCEDURE [dbo].[pindah_billing_umum_persh_pt_bpjs_sp]
...
BEGIN
UPDATE pindah_billing_umum_persh_pt_bpjs_v
...
END");
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS pindah_billing_umum_persh_pt_bpjs_sp");
    }
};
