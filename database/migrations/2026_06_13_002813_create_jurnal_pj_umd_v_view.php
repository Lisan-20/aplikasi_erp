...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.jurnal_pj_umd_v
AS
...
WHERE     (dbo.transaksi_pj_umd.tgl_ver IS NOT NULL) AND (dbo.transaksi_pj_umd.selisih = 0)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [jurnal_pj_umd_v]");
    }
};
