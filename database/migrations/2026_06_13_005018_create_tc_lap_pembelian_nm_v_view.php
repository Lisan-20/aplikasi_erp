...
AS
SELECT     dbo.tc_penerimaan_barang_nm.tgl_penerimaan, dbo.tc_penerimaan_barang_nm.kode_penerimaan, dbo.mt_barang_jasa.nama_brg, 
                      dbo.mt_barang_jasa.kode_brg, dbo.tc_po_nm_det.jumlah_besar, dbo.mt_barang_jasa.satuan_besar, dbo.mt_rekap_stok_nm.harga_beli, 
...
FROM         dbo.tc_penerimaan_barang_nm INNER JOIN
                      ...
                      dbo.mt_barang_jasa ON dbo.tc_penerimaan_barang_nm_detail.kode_brg = dbo.mt_barang_jasa.kode_brg INNER JOIN
