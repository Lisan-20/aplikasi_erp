...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.jml_pasien_meninggal_v
AS
...
WHERE     (dbo.ri_tc_rawatinap.status_pulang = 1) AND (dbo.ri_tc_riwayat_kelas.ket_keluar = 3)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [jml_pasien_meninggal_v]");
    }
};
