...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_trans_kasir')) {
            return;
        }

        Schema::create('tc_trans_kasir', function (Blueprint $table) {
            ...
            $table->primary(['kode_tc_trans_kasir'], 'pk_tc_trans_kasir');
        });
    }
    ...
    {
        Schema::dropIfExists('tc_trans_kasir');
    }
};
