...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.jurnal_trans_kasir_RJ_v
AS
SELECT     TOP (100) PERCENT dbo.tran_kasir.kode_tran_kasir, dbo.tran_kasir.kode_tc_trans_kasir, dbo.tran_kasir.no_registrasi, dbo.tran_kasir.no_mr, 
                      ...
                      dbo.tran_kasir.kode_perusahaan, dbo.tran_kasir.npp
...
WHERE     (dbo.mapping_transaksi_rs_v.kode_proses = 1) AND (dbo.tran_kasir.flag_jurnal IS NULL) AND (dbo.tran_kasir.seri_kuitansi IN ('AJ', 'RJ', 'NK'))
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [jurnal_trans_kasir_RJ_v]");
    }
};
