...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.cariPasienBedah_dr_operator_rj_v
AS
SELECT     dbo.mt_master_pasien.no_mr, dbo.mt_master_pasien.nama_pasien, dbo.tc_registrasi.no_registrasi, dbo.tc_kunjungan.no_kunjungan, dbo.tc_registrasi.kode_kelompok, 
                      ...
                      dbo.tc_bedah.kode_dr_bedah AS kode_dokter, dbo.mt_karyawan.nama_pegawai AS nama_dokter, dbo.tc_bedah.tgl_jam_mulai, dbo.mt_karyawan.no_induk, dbo.tc_bedah.tgl_jam_keluar, 
...
FROM         dbo.tc_registrasi INNER JOIN
                      ...
                      dbo.mt_karyawan ON dbo.tc_bedah.kode_dr_bedah = dbo.mt_karyawan.kode_dokter INNER JOIN
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [cariPasienBedah_dr_operator_rj_v]");
    }
};
