...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.ri_tc_riwayat_pasien_plang_meninggal_1_v
AS
...
WHERE     (dbo.ri_tc_rawatinap.status_pulang = 1) AND (dbo.tc_registrasi.status_batal IS NULL) AND (dbo.ri_tc_riwayat_kelas.kode_kematian = '1') AND (YEAR(dbo.tc_kunjungan.tgl_keluar) >= 2019)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [ri_tc_riwayat_pasien_plang_meninggal_1_v]");
    }
};
