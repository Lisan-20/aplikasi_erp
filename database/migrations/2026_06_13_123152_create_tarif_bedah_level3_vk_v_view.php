...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.tarif_bedah_level3_vk_v
AS
...
HAVING      (kode_bagian = '030501') AND (tingkatan = 3)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [tarif_bedah_level3_vk_v]");
    }
};
