...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE VIEW dbo.tc_penyusutan_asset_v
AS
SELECT     dbo.tc_penyusutan_asset.bln, dbo.tc_penyusutan_asset.thn, dbo.tc_penyusutan_asset.kode_barang, dbo.tc_penyusutan_asset.kode_bagian, dbo.tc_penyusutan_asset.asset_type, 
                      dbo.tc_penyusutan_asset.nominal_penyusutan, dbo.tc_penyusutan_asset.acc_d, dbo.tc_penyusutan_asset.no_induk, dbo.tc_penyusutan_asset.acc_k, dbo.mt_barang_nm.nama_brg, 
                      dbo.mt_barang_nm.satuan_besar, dbo.mt_barang_nm.satuan_kecil, dbo.mt_barang_nm.harga_beli, dbo.mt_account.acc_nama AS acc_nama_d, mt_account_1.acc_nama AS acc_nama_k, 
...
FROM         dbo.tc_penyusutan_asset INNER JOIN
                      ...
                      dbo.mt_barang_nm ON dbo.tc_penyusutan_asset.kode_barang = dbo.mt_barang_nm.kode_brg
");
    }
