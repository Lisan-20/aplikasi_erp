...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('mt_master_tarif_detail_sktm')) {
            return;
        }

        Schema::create('mt_master_tarif_detail_sktm', function (Blueprint $table) {
            $table->integer('kode_master_tarif_detail');
            ...
            $table->primary(['kode_master_tarif_detail'], 'pk_mt_master_tarif_detail_sktm');
        });
    }
    ...
    {
        Schema::dropIfExists('mt_master_tarif_detail_sktm');
    }
};
