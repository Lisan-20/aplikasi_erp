...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('fee_paramedis_temp')) {
            return;
        }

        Schema::create('fee_paramedis_temp', function (Blueprint $table) {
            $table->increments('id_fee_param_ri_temp');
    ...
    {
        Schema::dropIfExists('fee_paramedis_temp');
    }
};
