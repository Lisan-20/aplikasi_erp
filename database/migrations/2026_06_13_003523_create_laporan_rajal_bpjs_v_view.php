...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.laporan_rajal_bpjs_v
AS
SELECT     dbo.tc_registrasi.kode_kelompok, dbo.tc_trans_kasir.seri_kuitansi, dbo.tc_trans_kasir.tgl_jam, dbo.tc_trans_kasir.no_registrasi, dbo.tc_trans_kasir.bill, dbo.tc_trans_kasir.nk_perusahaan, 
                      ...
                      dbo.tc_trans_kasir.kode_loket, dbo.tc_registrasi.code, dbo.mt_diag_bpjs.description, dbo.tc_trans_kasir.no_kuitansi, dbo.tc_trans_kasir.no_mr, dbo.tc_sep_ri_temp.kode_cbg, 
                      dbo.tc_registrasi.noSep, dbo.tc_sep_ri_temp.jenis, dbo.tc_registrasi.tgl_jam_masuk
FROM         dbo.tc_registrasi INNER JOIN
                      dbo.tc_trans_kasir ON dbo.tc_registrasi.no_registrasi = dbo.tc_trans_kasir.no_registrasi LEFT OUTER JOIN
                      dbo.tc_sep_ri_temp ON dbo.tc_registrasi.no_mr = dbo.tc_sep_ri_temp.no_mr AND dbo.tc_registrasi.noSep = dbo.tc_sep_ri_temp.no_sep LEFT OUTER JOIN
...
GROUP BY dbo.tc_registrasi.kode_kelompok, dbo.tc_trans_kasir.seri_kuitansi, dbo.tc_trans_kasir.tgl_jam, dbo.tc_trans_kasir.no_registrasi, dbo.tc_trans_kasir.bill, dbo.tc_trans_kasir.nk_perusahaan, 
                      ...
                      dbo.tc_trans_kasir.kode_loket, dbo.tc_registrasi.code, dbo.mt_diag_bpjs.description, dbo.tc_trans_kasir.no_kuitansi, dbo.tc_trans_kasir.no_mr, dbo.tc_sep_ri_temp.kode_cbg, 
                      dbo.tc_registrasi.noSep, dbo.tc_sep_ri_temp.jenis, dbo.tc_registrasi.tgl_jam_masuk
HAVING      (NOT (dbo.tc_registrasi.kode_kelompok IN (1, 3, 5))) AND (dbo.tc_trans_kasir.status_batal IS NULL) AND (dbo.tc_trans_kasir.nk_perusahaan > 0) AND (dbo.tc_trans_kasir.seri_kuitansi IN ('AJ', 'NK'))
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [laporan_rajal_bpjs_v]");
    }
};
