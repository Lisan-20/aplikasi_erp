...
SELECT     TOP (100) PERCENT dbo.tc_po_det.kode_brg, dbo.tc_po_det.harga_satuan AS harga_satuan_netto, dbo.tc_po.kodesupplier, dbo.mt_supplier.namasupplier, 
                      dbo.tc_po.no_po, dbo.tc_po.id_tc_po, dbo.tc_po_det.id_tc_po_det, dbo.tc_po_det.satuan, dbo.mt_barang_jasa.nama_brg
FROM         dbo.tc_po INNER JOIN
                      ...
                      dbo.mt_barang_jasa ON dbo.tc_po_det.kode_brg = dbo.mt_barang_jasa.kode_brg
