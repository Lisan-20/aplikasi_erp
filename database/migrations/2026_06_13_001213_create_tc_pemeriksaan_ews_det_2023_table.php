...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_pemeriksaan_ews_det_2023')) {
            return;
        }

        Schema::create('tc_pemeriksaan_ews_det_2023', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tc_pemeriksaan_ews_det_2023');
    }
};
