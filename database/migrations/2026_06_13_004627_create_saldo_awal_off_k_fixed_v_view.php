...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.saldo_awal_off_k_fixed_v
AS
...
HAVING      (dbo.bd_tc_trans_detail.tx_tipe = '1')
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [saldo_awal_off_k_fixed_v]");
    }
};
