...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.sie_kinerja_rs_unit_v
AS
SELECT     SUM((CASE WHEN dbo.tc_trans_pelayanan.status_kredit = 1 THEN (- 1) ELSE 1 END) * (CASE WHEN dbo.tc_trans_pelayanan.bill_rs IS NULL THEN 0 ELSE dbo.tc_trans_pelayanan.bill_rs END)) 
                      ...
                      * (CASE WHEN dbo.tc_trans_pelayanan.bill_dr2 IS NULL THEN 0 ELSE dbo.tc_trans_pelayanan.bill_dr2 END)) AS bill_dr2, SUM((CASE WHEN dbo.tc_trans_pelayanan.status_kredit = 1 THEN (- 1) 
                      ...
                      AS lain_lain, dbo.tc_trans_pelayanan.kode_tc_trans_kasir, dbo.tc_trans_kasir.tgl_jam, dbo.tc_trans_pelayanan.kode_bagian, dbo.tc_trans_pelayanan.kode_kelompok, 
                      dbo.tc_trans_kasir.no_registrasi, dbo.mt_nasabah.id_grup, dbo.tc_trans_kasir.status_batal
FROM         dbo.tc_trans_kasir INNER JOIN
                      ...
                      dbo.mt_nasabah ON dbo.tc_trans_pelayanan.kode_kelompok = dbo.mt_nasabah.kode_kelompok
GROUP BY dbo.tc_trans_pelayanan.kode_tc_trans_kasir, dbo.tc_trans_kasir.tgl_jam, dbo.tc_trans_pelayanan.kode_bagian, dbo.tc_trans_pelayanan.kode_kelompok, dbo.tc_trans_kasir.no_registrasi, 
                      dbo.mt_nasabah.id_grup, dbo.tc_trans_kasir.status_batal
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [sie_kinerja_rs_unit_v]");
    }
};
