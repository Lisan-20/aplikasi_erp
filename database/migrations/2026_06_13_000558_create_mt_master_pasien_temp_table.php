...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('mt_master_pasien_temp')) {
            return;
        }

        Schema::create('mt_master_pasien_temp', function (Blueprint $table) {
            ...
            $table->string('no_ktp', 19)->nullable();
            ...
            $table->string('alasan_blokir', 50)->nullable();
            ...
            $table->string('no_mr_agent', 20)->nullable();
            $table->string('nama_agent', 50)->nullable();
            $table->integer('id_get_member')->nullable();
            $table->string('dok_ktp_kk', 50)->nullable();
            $table->text('ttd')->nullable();
            $table->text('ft_ktp')->nullable();
            $table->text('ft_kartu_keluarga')->nullable();
            $table->text('ft_kartu')->nullable();
        });
    }
    ...
    {
        Schema::dropIfExists('mt_master_pasien_temp');
    }
};
