...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.tc_pemeriksaan_fisik_dok_v
AS
...
WHERE     (dbo.tc_pemeriksaan_dokter_v.kode_pemeriksaan >= N'40221') AND (dbo.tc_pemeriksaan_dokter_v.kode_pemeriksaan < N'40268') AND (dbo.mt_acc_erm_det.value = 2)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [tc_pemeriksaan_fisik_dok_v]");
    }
};
