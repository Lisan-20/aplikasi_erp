...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_kunjungan_batal')) {
            return;
        }

        Schema::create('tc_kunjungan_batal', function (Blueprint $table) {
            $table->integer('id_tc_kunjungan')->nullable();
    ...
    {
        Schema::dropIfExists('tc_kunjungan_batal');
    }
};
