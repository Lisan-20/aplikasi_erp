...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_pemeriksaan_resep')) {
            return;
        }

        Schema::create('tc_pemeriksaan_resep', function (Blueprint $table) {
            ...
            $table->integer('kode_trans_far')->nullable()->index('ix_kode_trans_far');
        });
    }
    ...
    {
        Schema::dropIfExists('tc_pemeriksaan_resep');
    }
};
