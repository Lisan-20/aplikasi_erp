...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_permohonan_nm_det')) {
            return;
        }

        Schema::create('tc_permohonan_nm_det', function (Blueprint $table) {
            ...
            $table->text('keterangan_kirim')->nullable();
        });
    }
    ...
    {
        Schema::dropIfExists('tc_permohonan_nm_det');
    }
};
