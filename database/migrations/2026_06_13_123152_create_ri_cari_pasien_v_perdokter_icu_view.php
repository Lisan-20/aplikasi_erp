...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.ri_cari_pasien_v_perdokter_icu
AS
...
WHERE     (dbo.ri_cari_pasien_v.bag_pas IN ('031001', '033001'))
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [ri_cari_pasien_v_perdokter_icu]");
    }
};
