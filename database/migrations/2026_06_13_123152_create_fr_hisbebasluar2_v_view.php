...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.fr_hisbebasluar2_v
AS
SELECT     dbo.fr_tc_far.kode_trans_far, dbo.fr_tc_far.tgl_trans, dbo.fr_tc_far.dokter_pengirim, dbo.fr_tc_far.nama_pasien, dbo.fr_tc_far.alamat_pasien, dbo.fr_tc_far.telpon_pasien, 
                      ...
                      dbo.fr_tc_far_detail.status_retur, dbo.fr_tc_far_his.ket_his, dbo.fr_tc_far_detail.alasan_retur, dbo.fr_tc_far_detail.biaya_tebus, dbo.mt_barang.satuan_kecil
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [fr_hisbebasluar2_v]");
    }
};
