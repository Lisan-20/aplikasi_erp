...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('lap_kunjungan_ok_tind_temp')) {
            return;
        }

        Schema::create('lap_kunjungan_ok_tind_temp', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('lap_kunjungan_ok_tind_temp');
    }
};
