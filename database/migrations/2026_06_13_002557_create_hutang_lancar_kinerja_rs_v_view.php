...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.hutang_lancar_kinerja_rs_v
AS
...
HAVING      (dbo.mt_account.kode_utama = '2') AND (dbo.mt_account.referensi LIKE '21%')
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [hutang_lancar_kinerja_rs_v]");
    }
};
