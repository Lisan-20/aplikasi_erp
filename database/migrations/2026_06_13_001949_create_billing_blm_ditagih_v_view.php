...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.billing_blm_ditagih_v
AS
...
WHERE     (dbo.tc_trans_kasir.kd_inv_persh_tx IS NULL OR
                      dbo.tc_trans_kasir.kd_inv_persh_tx = 0) AND (dbo.tc_trans_kasir.status_batal IS NULL) AND (dbo.tc_trans_kasir.flag_tagih = 1)
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [billing_blm_ditagih_v]");
    }
};
