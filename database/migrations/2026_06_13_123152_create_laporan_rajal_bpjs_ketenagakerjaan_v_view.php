...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.laporan_rajal_bpjs_ketenagakerjaan_v
AS
...
HAVING        (dbo.tc_registrasi.kode_kelompok = 8) AND (dbo.tc_trans_kasir.status_batal IS NULL) AND (dbo.tc_trans_kasir.nk_perusahaan > 0) AND (dbo.tc_trans_kasir.seri_kuitansi IN ('AJ', 'NK'))
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [laporan_rajal_bpjs_ketenagakerjaan_v]");
    }
};
