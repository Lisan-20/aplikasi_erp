...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.jurnal_selisih_bpjs_ri_baru_v
AS
...
HAVING      (dbo.upload_sep_temp.jenis = 'RI') AND (dbo.upload_sep_temp.flag_jurnal IS NULL)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [jurnal_selisih_bpjs_ri_baru_v]");
    }
};
