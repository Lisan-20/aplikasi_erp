...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.shift1_absensi_v
AS
...
FROM         dbo.mt_karyawan INNER JOIN
                      ...
                      dbo.ks_mt_shift
WHERE     (dbo.tc_absensi.npp <> '') AND (dbo.ks_mt_shift.kode_shift = 1) AND (YEAR(dbo.tc_absensi.jam_masuk) = 2022) AND (dbo.mt_karyawan.st_shift = 2) AND (DATEDIFF(MINUTE, 
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [shift1_absensi_v]");
    }
};
