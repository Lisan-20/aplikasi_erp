...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.pl_mt_pasien_v
AS
SELECT     TOP (100) PERCENT dbo.pl_tc_poli.id_pl_tc_poli, dbo.pl_tc_poli.kode_poli, dbo.pl_tc_poli.no_kunjungan, dbo.pl_tc_poli.kode_bagian, dbo.pl_tc_poli.no_antrian, dbo.pl_tc_poli.tgl_jam_poli, 
                      ...
                      dbo.tc_registrasi.kode_bagian_masuk, dbo.mt_master_pasien.st_alergi, dbo.mt_master_pasien.st_resum, dbo.tc_registrasi.flag_skd, dbo.tc_registrasi.flag_skb, dbo.tc_registrasi.flag_skk, 
                      dbo.tc_registrasi.flag_skh, dbo.tc_registrasi.flag_sch, dbo.tc_registrasi.st_ass_dr_igd, dbo.tc_registrasi.st_ass_awal_fisio, dbo.tc_registrasi.st_ass_awal, dbo.tc_registrasi.st_ass_awal_lanjutan, 
                      ...
                      dbo.tc_registrasi.saran, dbo.tc_registrasi.status_kes, dbo.tc_registrasi.st_usg, dbo.tc_registrasi.st_ass_awal_hemo, dbo.tc_registrasi.st_ass_inv_fisio, CASE WHEN daftar_ol IS NULL 
                      THEN 2 ELSE daftar_ol END AS daftar_ol, dbo.tc_registrasi.kode_booking, dbo.tc_registrasi.respon_addantrian
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [pl_mt_pasien_v]");
    }
};
