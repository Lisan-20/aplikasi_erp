...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.pl_mt_pasien_daftar_onlen_v
AS
...
WHERE     (dbo.tc_registrasi.status_batal IS NULL) AND (dbo.tc_kunjungan.tgl_keluar IS NULL) AND (dbo.tc_registrasi.daftar_ol IN (1, 15))
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [pl_mt_pasien_daftar_onlen_v]");
    }
};
