...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.resum_pasien_fisio_v
AS
SELECT     dbo.tc_trans_kasir.seri_kuitansi, dbo.tc_trans_kasir.no_kuitansi, dbo.tc_trans_kasir.no_registrasi, dbo.tc_trans_kasir.no_mr, dbo.tc_trans_kasir.tgl_jam, dbo.tc_registrasi.kode_kelompok, 
                      ...
                      dbo.tc_registrasi.ttd, dbo.tc_trans_kasir.flag_ver_berkas, dbo.mt_bagian.nama_bagian, dbo.tc_registrasi.kode_bagian_masuk, dbo.tc_registrasi.noRujukan, dbo.tc_kunjungan.kode_bagian_tujuan, 
                      dbo.tc_kunjungan.kode_bagian_asal
...
WHERE     (dbo.tc_trans_kasir.status_batal IS NULL) AND (dbo.tc_registrasi.kode_kelompok NOT IN (1, 5, 3)) AND (dbo.tc_kunjungan.kode_bagian_tujuan = '050301') AND 
                      (dbo.tc_trans_kasir.status_batal IS NULL) AND (NOT (dbo.tc_kunjungan.kode_bagian_asal LIKE '03%'))
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [resum_pasien_fisio_v]");
    }
};
