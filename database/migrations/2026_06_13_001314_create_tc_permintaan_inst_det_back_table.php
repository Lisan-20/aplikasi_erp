...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_permintaan_inst_det_back')) {
            return;
        }

        Schema::create('tc_permintaan_inst_det_back', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tc_permintaan_inst_det_back');
    }
};
