...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_permohonan_cash_det_gizi_new')) {
            return;
        }

        Schema::create('tc_permohonan_cash_det_gizi_new', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tc_permohonan_cash_det_gizi_new');
    }
};
