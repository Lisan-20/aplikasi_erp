...
-- =============================================
CREATE OR ALTER PROCEDURE [dbo].[jurnal_sed_partik_RI_sp]
AS
BEGIN
...
");
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS jurnal_sed_partik_RI_sp");
    }
};
