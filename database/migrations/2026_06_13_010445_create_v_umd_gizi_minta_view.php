...
AS
SELECT     dbo.transaksi_umd.kode_bagian, dbo.mt_bagian.nama_bagian, dbo.transaksi_umd.no_bukti, dbo.transaksi_umd.tgl_transaksi, dbo.transaksi_umd_detail.kode_brg, dbo.mt_barang_jasa.nama_brg, 
...
FROM         dbo.transaksi_umd INNER JOIN
                      ...
                      dbo.mt_barang_jasa ON dbo.transaksi_umd_detail.kode_brg = dbo.mt_barang_jasa.kode_brg INNER JOIN
