...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.v_trans_kasir_RI
AS
SELECT     dbo.tc_trans_kasir.kode_tc_trans_kasir, dbo.tc_trans_kasir.seri_kuitansi, dbo.tc_trans_kasir.no_kuitansi, dbo.tc_trans_kasir.no_kuitansi_bendahara, 
                      ...
                      dbo.tc_registrasi.kode_perusahaan, dbo.tc_trans_kasir.kode_inap
FROM         dbo.tc_trans_kasir INNER JOIN
                      dbo.tc_registrasi ON dbo.tc_trans_kasir.no_registrasi = dbo.tc_registrasi.no_registrasi
WHERE     (dbo.tc_trans_kasir.flag_jurnal = 0) AND (dbo.tc_trans_kasir.status_batal IS NULL) AND (dbo.tc_trans_kasir.seri_kuitansi IN ('AI', 'RI')) AND 
                      (NOT (dbo.tc_trans_kasir.tgl_ver IS NULL))
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [v_trans_kasir_RI]");
    }
};
