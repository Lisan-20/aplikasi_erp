...
CREATE OR ALTER PROCEDURE [dbo].[inp_tran_sed_adm_ASKES_RJ_sp]
as
-- administrasi pasien
...
");
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS inp_tran_sed_adm_ASKES_RJ_sp");
    }
};
