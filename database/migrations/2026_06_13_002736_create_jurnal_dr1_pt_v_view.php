...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.jurnal_dr1_pt_v
AS
SELECT     dbo.tc_trans_pelayanan.kode_tc_trans_kasir, dbo.tc_trans_pelayanan.no_registrasi, dbo.tc_trans_pelayanan.no_mr, dbo.tc_trans_pelayanan.jenis_tindakan, 
                      ...
                      dbo.tc_trans_kasir.tgl_jam, dbo.tc_registrasi.kode_perusahaan, dbo.tc_registrasi.kode_kelompok, dbo.mt_perusahaan.flag, dbo.tc_trans_pelayanan.nama_tindakan, 
                      dbo.tc_registrasi.kode_dokter
...
WHERE     (dbo.mapping_transaksi_rs_v.kode_proses = 2) AND (dbo.mapping_transaksi_rs_v.kode_jenis_proses = 11) AND (dbo.tc_trans_kasir.seri_kuitansi IN ('AJ', 'RJ')) AND 
                      (dbo.tc_trans_pelayanan.kode_barang IS NULL) AND (dbo.tc_trans_pelayanan.flag_jurnal = 0) AND (dbo.tc_trans_kasir.status_batal IS NULL) AND 
                      (dbo.mt_perusahaan.flag = 0 OR
                      dbo.mt_perusahaan.flag IS NULL) AND (dbo.tc_registrasi.kode_perusahaan > 0) AND (dbo.tc_trans_pelayanan.bill_dr1 > 0) AND 
...
GROUP BY dbo.tc_trans_pelayanan.kode_tc_trans_kasir, dbo.tc_trans_pelayanan.no_registrasi, dbo.tc_trans_pelayanan.no_mr, dbo.tc_trans_pelayanan.jenis_tindakan, 
                      ...
                      dbo.tc_registrasi.kode_perusahaan, dbo.tc_registrasi.kode_kelompok, dbo.mt_perusahaan.flag, dbo.tc_trans_pelayanan.nama_tindakan, dbo.tc_registrasi.kode_dokter
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [jurnal_dr1_pt_v]");
    }
};
