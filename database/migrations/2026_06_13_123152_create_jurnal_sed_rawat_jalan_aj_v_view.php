...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.jurnal_sed_rawat_jalan_aj_v
AS
SELECT     dbo.tc_trans_pelayanan.kode_tc_trans_kasir, dbo.tc_trans_pelayanan.no_registrasi, dbo.tc_trans_pelayanan.no_mr, dbo.tc_trans_pelayanan.kode_kelompok, 
                      dbo.tc_trans_pelayanan.kode_perusahaan, dbo.tc_trans_pelayanan.jenis_tindakan, SUM(dbo.tc_trans_pelayanan.bill_rs_jatah) AS bill_rs, 
                      SUM(dbo.tc_trans_pelayanan.bill_dr1_jatah) AS bill_dr1, dbo.tc_trans_pelayanan.kode_dokter1, dbo.tc_trans_pelayanan.kode_bagian, 
...
WHERE     (dbo.mapping_transaksi_rs_v.kode_proses = 2) AND (dbo.tc_trans_kasir.seri_kuitansi = 'AJ') AND (dbo.tc_trans_pelayanan.kode_barang IS NULL) AND 
                      (dbo.tc_trans_pelayanan.flag_jurnal = 0)
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [jurnal_sed_rawat_jalan_aj_v]");
    }
};
