...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.jurnal_pengiriman_unit_nm_kredit2_v
AS
...
FROM         dbo.mapping_transaksi_rs_v INNER JOIN
                      ...
                      dbo.tc_permintaan_inst_nm_det ON dbo.mt_barang_jasa.kode_brg = dbo.tc_permintaan_inst_nm_det.kode_brg ON dbo.mt_rekap_stok_nm.kode_brg = dbo.tc_permintaan_inst_nm_det.kode_brg ON 
...
HAVING      (dbo.tc_permintaan_inst_nm_det.jumlah_penerimaan > 0) AND (dbo.mapping_transaksi_rs_v.kode_proses = 14) AND (dbo.mt_rekap_stok_nm.kode_bagian_gudang = '070101') AND 
                      (dbo.mapping_transaksi_rs_v.acc_kredit > N'0') AND (dbo.mt_rekap_stok_nm.harga_beli * dbo.tc_permintaan_inst_nm_det.jumlah_penerimaan > 0) AND (dbo.mt_barang_jasa.kode_golongan = 'F04')
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [jurnal_pengiriman_unit_nm_kredit2_v]");
    }
};
