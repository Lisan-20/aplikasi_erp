...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('th_permohonan_nm_det')) {
            return;
        }

        Schema::create('th_permohonan_nm_det', function (Blueprint $table) {
            ...
            $table->integer('status_po')->nullable()->default(0);
    ...
    {
        Schema::dropIfExists('th_permohonan_nm_det');
    }
};
