...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.tc_lap_bagian_harian_v
AS
...
GROUP BY dbo.tc_trans_pelayanan.no_kunjungan, dbo.tc_trans_pelayanan.no_mr, dbo.tc_trans_pelayanan.kode_dokter1, MONTH(dbo.tc_kunjungan.tgl_keluar), 
                      ...
                      dbo.tc_kunjungan.kode_bagian_tujuan, dbo.tc_kunjungan.tgl_keluar, dbo.tc_registrasi.status_batal, dbo.tc_trans_kasir.seri_kuitansi, dbo.tc_trans_kasir.no_kuitansi, 
                      dbo.tc_trans_pelayanan.kode_paramedis
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [tc_lap_bagian_harian_v]");
    }
};
