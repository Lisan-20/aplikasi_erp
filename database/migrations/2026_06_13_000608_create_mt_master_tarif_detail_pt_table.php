...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('mt_master_tarif_detail_pt')) {
            return;
        }

        Schema::create('mt_master_tarif_detail_pt', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mt_master_tarif_detail_pt');
    }
};
