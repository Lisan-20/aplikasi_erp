...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.v_edit_bd_tc_trans
AS
SELECT     TOP (100) PERCENT dbo.bd_tc_trans_detail.flag_jurnal, dbo.bd_tc_trans_detail.id_bd_tc_trans_det, dbo.bd_tc_trans_detail.id_bd_tc_trans, dbo.bd_tc_trans_detail.kd_group_trans, 
                      ...
                      dbo.bd_tc_trans_detail.no_urut, dbo.bd_tc_trans_detail.status, dbo.bd_tc_trans.flag_tmp, dbo.bd_tc_trans_detail.user_edit_t, dbo.bd_tc_trans_detail.user_edit_v, dbo.bd_tc_trans_detail.no_ref, 
                      dbo.bd_tc_trans.tgl_transaksi, YEAR(dbo.bd_tc_trans.tgl_transaksi) AS Expr1
...
WHERE     (dbo.bd_tc_trans_detail.tgl_ver IS NULL) AND (dbo.bd_tc_trans_detail.flag_jurnal = 0) AND (dbo.bd_tc_trans.flag_tmp IS NULL) AND (dbo.bd_tc_trans.status IS NULL) AND 
                      (dbo.bd_tc_trans_detail.kd_trans_bendahara <> '1107') AND (YEAR(dbo.bd_tc_trans.tgl_transaksi) >= 2021)
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [v_edit_bd_tc_trans]");
    }
};
