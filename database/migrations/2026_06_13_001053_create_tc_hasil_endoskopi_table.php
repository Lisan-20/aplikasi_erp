...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_hasil_endoskopi')) {
            return;
        }

        Schema::create('tc_hasil_endoskopi', function (Blueprint $table) {
            $table->bigIncrements('id_endoskopi');
    ...
    {
        Schema::dropIfExists('tc_hasil_endoskopi');
    }
};
