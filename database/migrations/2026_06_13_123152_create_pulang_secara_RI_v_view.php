...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.pulang_secara_RI_v
AS
...
HAVING      (dbo.gd_daftar_antrian_pulang_v.status_periksa = 2)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [pulang_secara_RI_v]");
    }
};
