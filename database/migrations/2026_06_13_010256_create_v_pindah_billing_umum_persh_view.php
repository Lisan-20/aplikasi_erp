...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.v_pindah_billing_umum_persh
AS
SELECT     TOP (100) PERCENT dbo.mt_master_tarif.kode_tarif, dbo.mt_master_tarif.nama_tarif, dbo.mt_master_tarif.kode_bagian, dbo.mt_bagian.nama_bagian, 
                      dbo.mt_master_tarif_detail.kode_klas, dbo.mt_klas.nama_klas, dbo.mt_master_tarif_detail.bill_rs, dbo.tc_trans_pelayanan.bill_rs AS bill_rs_trans, 
                      dbo.mt_master_tarif_detail.bill_dr1, dbo.tc_trans_pelayanan.bill_dr1 AS bill_dr1_trans, dbo.mt_master_tarif_detail.bill_dr2, 
...
FROM         dbo.mt_master_tarif INNER JOIN
                      ...
                      dbo.tc_trans_pelayanan ON dbo.mt_master_tarif.kode_tarif = dbo.tc_trans_pelayanan.kode_tarif AND dbo.mt_klas.kode_klas = dbo.tc_trans_pelayanan.kode_klas AND
                       dbo.mt_bagian.group_bag = dbo.tc_trans_pelayanan.kode_klas
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [v_pindah_billing_umum_persh]");
    }
};
