...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_bpako_paketSC')) {
            return;
        }

        Schema::create('tc_bpako_paketSC', function (Blueprint $table) {
            $table->integer('id_tc_bpako_paketSC');
    ...
    {
        Schema::dropIfExists('tc_bpako_paketSC');
    }
};
