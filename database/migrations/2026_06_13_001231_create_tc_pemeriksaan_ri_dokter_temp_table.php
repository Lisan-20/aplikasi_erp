...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_pemeriksaan_ri_dokter_temp')) {
            return;
        }

        Schema::create('tc_pemeriksaan_ri_dokter_temp', function (Blueprint $table) {
            ...
            $table->integer('kd_ref')->nullable()->index('ix_kd_ref');
            $table->string('ket', 550)->nullable();
        });
    }
    ...
    {
        Schema::dropIfExists('tc_pemeriksaan_ri_dokter_temp');
    }
};
