...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.v_trans_pelayanan_ASKES_RJ_v
AS
SELECT     dbo.tc_trans_pelayanan.kode_trans_pelayanan, dbo.tc_trans_pelayanan.kode_tc_trans_kasir, dbo.tc_trans_pelayanan.no_kunjungan, 
                      ...
                      dbo.tc_trans_pelayanan.status_batal, dbo.tc_trans_pelayanan.diskon_rs, dbo.tc_trans_pelayanan.diskon_dr1, dbo.tc_trans_pelayanan.diskon_dr2, 
...
WHERE     (dbo.tc_trans_pelayanan.flag_jurnal = 0) AND (dbo.tc_trans_kasir.status_batal IS NULL) AND (dbo.tc_trans_pelayanan.jenis_tindakan > 0) AND 
                      (dbo.tc_trans_kasir.seri_kuitansi IN ('AJ', 'RJ', 'NK')) AND (dbo.tc_trans_pelayanan.kode_kelompok IN (6, 7, 8, 9, 10)) AND (dbo.tc_registrasi.kode_perusahaan = 0 OR
                      dbo.tc_registrasi.kode_perusahaan IS NULL) AND (dbo.tc_trans_pelayanan.status_batal IS NULL)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [v_trans_pelayanan_ASKES_RJ_v]");
    }
};
