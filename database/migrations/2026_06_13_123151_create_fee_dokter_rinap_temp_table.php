...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('fee_dokter_rinap_temp')) {
            return;
        }

        Schema::create('fee_dokter_rinap_temp', function (Blueprint $table) {
            $table->increments('id_fee_dr_ri_temp');
            ...
            $table->integer('flag_bedah_bpjs')->nullable();
    ...
    {
        Schema::dropIfExists('fee_dokter_rinap_temp');
    }
};
