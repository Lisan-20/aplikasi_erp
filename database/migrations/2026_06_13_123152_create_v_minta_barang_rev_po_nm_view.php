...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE VIEW dbo.v_minta_barang_rev_po_nm
AS
SELECT     dbo.mt_barang_nm.nama_brg, dbo.tc_permohonan_nm_det.kode_brg, dbo.tc_permohonan_nm_det.jumlah_besar, dbo.tc_permohonan_nm_det.jumlah_besar_acc, 
...
FROM         dbo.tc_permohonan_nm_det INNER JOIN
                      dbo.mt_barang_nm ON dbo.tc_permohonan_nm_det.kode_brg = dbo.mt_barang_nm.kode_brg
