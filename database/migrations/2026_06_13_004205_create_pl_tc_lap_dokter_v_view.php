...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.pl_tc_lap_dokter_v
AS
SELECT     dbo.pl_tc_poli.no_kunjungan, dbo.pl_tc_poli.tgl_jam_poli, dbo.tc_kunjungan.no_mr, dbo.mt_master_pasien.nama_pasien, 
                      dbo.mt_master_pasien.jen_kelamin, dbo.mt_master_pasien.kode_kelompok, dbo.mt_master_pasien.tgl_lhr, SUM(dbo.tc_trans_pelayanan.bill_dr1) 
                      AS bill_dokter, dbo.tc_kunjungan.tgl_keluar, dbo.tc_registrasi.stat_pasien, dbo.tc_kunjungan.status_keluar, 
                      dbo.pl_tc_poli.kode_bagian AS kode_bagian_poli, dbo.pl_tc_poli.kode_dokter
...
GROUP BY dbo.pl_tc_poli.no_kunjungan, dbo.pl_tc_poli.tgl_jam_poli, dbo.tc_kunjungan.no_mr, dbo.mt_master_pasien.nama_pasien, 
                      ...
                      dbo.tc_kunjungan.status_keluar, dbo.tc_kunjungan.tgl_keluar, dbo.tc_registrasi.stat_pasien, dbo.pl_tc_poli.kode_bagian, 
                      dbo.pl_tc_poli.kode_dokter
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [pl_tc_lap_dokter_v]");
    }
};
