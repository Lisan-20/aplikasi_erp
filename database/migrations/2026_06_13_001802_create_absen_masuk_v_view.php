...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.absen_masuk_v
AS
SELECT     TOP (100) PERCENT dbo.CHECKINOUT_OK.USERID, dbo.CHECKINOUT_OK.CHECKTYPE, DAY(dbo.CHECKINOUT_OK.CHECKTIME) AS tgl, MONTH(dbo.CHECKINOUT_OK.CHECKTIME) AS bln, 
                      ...
                      dbo.CHECKINOUT_OK.SENSORID, dbo.CHECKINOUT_OK.Memoinfo, dbo.CHECKINOUT_OK.WorkCode, dbo.CHECKINOUT_OK.sn, dbo.mt_karyawan.nama_pegawai, dbo.CHECKINOUT_OK.id_check, 
                      dbo.CHECKINOUT_OK.UserExtFmt, { fn HOUR(dbo.CHECKINOUT_OK.CHECKTIME) } AS jam, { fn MINUTE(dbo.CHECKINOUT_OK.CHECKTIME) } AS menit, dbo.mt_karyawan.st_shift, 
                      dbo.CHECKINOUT_OK.npp
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [absen_masuk_v]");
    }
};
