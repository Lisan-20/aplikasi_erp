...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.mt_tarif_perusahaan_v
AS
SELECT     TOP (100) PERCENT dbo.mt_master_tarif.kode_tarif, dbo.mt_master_tarif.nama_tarif, dbo.mt_master_tarif_detail_perusahaan.kode_klas, dbo.mt_klas.nama_klas, 
                      ...
                      dbo.mt_master_tarif_detail_perusahaan.kode_perusahaan, dbo.mt_master_tarif_detail_perusahaan.pa_rs, dbo.mt_master_tarif_detail_perusahaan.pa_dr1, 
                      dbo.mt_master_tarif_detail_perusahaan.pa_dr2, dbo.mt_master_tarif.kode_tindakan, dbo.mt_bagian.nama_bagian, 
                      dbo.mt_master_tarif_detail_perusahaan.bill_rs_spesialis, dbo.mt_master_tarif_detail_perusahaan.bill_dr1_spesialis, 
                      dbo.mt_master_tarif_detail_perusahaan.bill_dr2_spesialis, dbo.mt_master_tarif_detail_perusahaan.pendapatan_rs_spesialis, 
                      dbo.mt_master_tarif_detail_perusahaan.bill_rs_rujukan, dbo.mt_master_tarif_detail_perusahaan.total_spesialis
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [mt_tarif_perusahaan_v]");
    }
};
