...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.fr_far_resep_ri_dokter_apo_cito_v
AS
SELECT     dbo.fr_far_resep_ri_dokter.id_resep_ri_dr, dbo.fr_far_resep_ri_dokter.kode_resep, dbo.fr_far_resep_ri_dokter.no_kunjungan, dbo.fr_far_resep_ri_dokter.no_registrasi, 
                      ...
                      dbo.mt_bagian.kode_depo_bag, dbo.fr_far_resep_ri_dokter.flag_permintaan, dbo.fr_far_resep_ri_dokter.flag_1x, dbo.fr_far_resep_ri_dokter.kode_bagian_isi
...
WHERE     (dbo.tc_registrasi.status_batal IS NULL) AND (dbo.fr_far_resep_ri_dokter.flag_permintaan IN (3, 2)) AND (dbo.fr_far_resep_ri_dokter.kode_bagian_isi <> '020101') AND 
                      (dbo.fr_far_resep_ri_dokter.flag_1x IS NULL)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [fr_far_resep_ri_dokter_apo_cito_v]");
    }
};
