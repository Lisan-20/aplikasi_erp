...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.lap_kunjungan_ok_jamkesda_v
AS
...
HAVING      (dbo.tc_trans_pelayanan.kode_bagian IN ('030901', '030501')) AND (dbo.lap_kunjungan_LP_v.kode_kelompok = 10)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [lap_kunjungan_ok_jamkesda_v]");
    }
};
