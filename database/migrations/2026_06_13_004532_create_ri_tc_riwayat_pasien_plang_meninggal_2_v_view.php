...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.ri_tc_riwayat_pasien_plang_meninggal_2_v
AS
SELECT     dbo.mt_master_pasien.no_mr, dbo.tc_registrasi.no_registrasi, dbo.tc_kunjungan.no_kunjungan, dbo.ri_tc_rawatinap.kode_ri, dbo.mt_master_pasien.nama_pasien, 
                      ...
                      dbo.ri_tc_riwayat_kelas.kode_kematian, dbo.ri_tc_riwayat_kelas.ket_keluar, dbo.ri_tc_riwayat_kelas.waktu_kematian, MONTH(dbo.tc_kunjungan.tgl_keluar) AS bln, 
...
WHERE     (dbo.tc_registrasi.status_batal IS NULL) AND (dbo.ri_tc_riwayat_kelas.ket_keluar = 4) AND (dbo.ri_tc_riwayat_kelas.kode_kematian IS NULL) AND (YEAR(dbo.tc_kunjungan.tgl_keluar) >= 2014)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [ri_tc_riwayat_pasien_plang_meninggal_2_v]");
    }
};
