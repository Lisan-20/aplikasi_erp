...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_pemeriksaan_triase')) {
            return;
        }

        Schema::create('tc_pemeriksaan_triase', function (Blueprint $table) {
            ...
            $table->integer('RESUSITASI')->nullable();
            $table->integer('EMERGENSI')->nullable();
            $table->integer('URGENT')->nullable();
            $table->integer('NON_URGENT')->nullable();
            $table->integer('FALSE_EMERGENSI')->nullable();
        });
    }
    ...
    {
        Schema::dropIfExists('tc_pemeriksaan_triase');
    }
};
