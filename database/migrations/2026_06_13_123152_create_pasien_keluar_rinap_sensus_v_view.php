...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.pasien_keluar_rinap_sensus_v
AS
...
WHERE        (dbo.tc_kunjungan.status_batal IS NULL) AND (dbo.ri_tc_riwayat_kelas.ket_keluar IS NOT NULL)
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [pasien_keluar_rinap_sensus_v]");
    }
};
