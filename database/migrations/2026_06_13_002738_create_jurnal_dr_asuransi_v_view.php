...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.jurnal_dr_asuransi_v
AS
SELECT     dbo.tc_trans_pelayanan.kode_tc_trans_kasir, dbo.tc_trans_pelayanan.no_registrasi, dbo.tc_trans_pelayanan.no_mr, dbo.tc_trans_pelayanan.jenis_tindakan, 
                      ...
                      AS lain_lain, SUM(dbo.tc_trans_pelayanan.bill_dr2_jatah) AS bill_dr2, dbo.tc_trans_pelayanan.kode_barang, dbo.mapping_transaksi_rs_v.acc_debet, 
                      dbo.mapping_transaksi_rs_v.acc_kredit, dbo.mapping_transaksi_rs_v.nama_debet, dbo.mapping_transaksi_rs_v.nama_kredit, 
                      dbo.mapping_transaksi_rs_v.nama_bagian, dbo.tc_trans_kasir.no_kuitansi, dbo.tc_trans_kasir.tgl_jam, dbo.tc_registrasi.kode_perusahaan, 
                      dbo.tc_registrasi.kode_kelompok, dbo.mt_perusahaan.flag
FROM         dbo.tc_trans_pelayanan INNER JOIN
                      ...
                      dbo.mapping_transaksi_rs_v ON dbo.tc_trans_pelayanan.kode_bagian = dbo.mapping_transaksi_rs_v.kode_bagian INNER JOIN
...
WHERE     (dbo.mapping_transaksi_rs_v.kode_proses = 2) AND (dbo.tc_trans_kasir.seri_kuitansi IN ('AJ', 'RJ')) AND (dbo.tc_trans_pelayanan.kode_barang IS NULL) AND 
                      (dbo.tc_trans_pelayanan.flag_jurnal = 0) AND (dbo.tc_trans_kasir.status_batal IS NULL) AND (dbo.mt_perusahaan.flag = 1) AND 
                      (dbo.tc_registrasi.kode_perusahaan > 0) AND (dbo.mapping_transaksi_rs_v.kode_jenis_proses = 11) AND (dbo.tc_trans_pelayanan.bill_dr1_jatah > 0) AND 
                      (dbo.mapping_transaksi_rs_v.kode_jenis_proses = 11)
GROUP BY dbo.tc_trans_pelayanan.kode_tc_trans_kasir, dbo.tc_trans_pelayanan.no_registrasi, dbo.tc_trans_pelayanan.no_mr, dbo.tc_trans_pelayanan.jenis_tindakan, 
                      ...
                      dbo.tc_registrasi.kode_perusahaan, dbo.tc_registrasi.kode_kelompok, dbo.mt_perusahaan.flag
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [jurnal_dr_asuransi_v]");
    }
};
