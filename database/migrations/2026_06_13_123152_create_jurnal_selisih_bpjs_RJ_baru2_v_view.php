...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.jurnal_selisih_bpjs_RJ_baru2_v
AS
...
WHERE     (dbo.upload_sep_temp.jenis = 'RJ') AND (dbo.upload_sep_temp.flag_jurnal IS NULL)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [jurnal_selisih_bpjs_RJ_baru2_v]");
    }
};
