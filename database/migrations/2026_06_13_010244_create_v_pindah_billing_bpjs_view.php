...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.v_pindah_billing_bpjs
AS
SELECT     TOP (100) PERCENT dbo.mt_master_tarif.kode_tarif, dbo.mt_master_tarif.nama_tarif, dbo.mt_master_tarif.kode_bagian, dbo.mt_bagian.nama_bagian, 
                      dbo.mt_master_tarif_detail.kode_klas, dbo.mt_klas.nama_klas, (CASE WHEN bill_rs_bpjs IS NULL THEN 0 ELSE bill_rs_bpjs END) AS bill_rs, 
                      dbo.tc_trans_pelayanan.bill_rs_jatah AS bill_rs_trans, (CASE WHEN bill_dr1_bpjs IS NULL THEN 0 ELSE bill_dr1_bpjs END) AS bill_dr1, 
                      dbo.tc_trans_pelayanan.bill_dr1_jatah AS bill_dr1_trans, (CASE WHEN bill_dr2_bpjs IS NULL THEN 0 ELSE bill_dr2_bpjs END) AS bill_dr2, 
                      dbo.tc_trans_pelayanan.bill_dr2_jatah AS bill_dr2_trans, dbo.mt_master_tarif_detail.total, dbo.tc_trans_pelayanan.kode_trans_pelayanan, 
                      dbo.tc_trans_pelayanan.no_registrasi, dbo.tc_trans_pelayanan.no_mr, dbo.tc_trans_pelayanan.no_kunjungan, 
                      dbo.tc_trans_pelayanan.kode_tc_trans_kasir, dbo.tc_trans_pelayanan.kode_kelompok, dbo.tc_trans_pelayanan.kode_bagian_asal, 
                      dbo.tc_trans_pelayanan.kode_bagian AS kode_bagian_trans, dbo.tc_trans_pelayanan.jumlah, dbo.mt_master_tarif.flag_rujukan, 
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [v_pindah_billing_bpjs]");
    }
};
