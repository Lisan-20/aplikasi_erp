...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.rj_mt_pasien_penunjang_v
AS
SELECT     TOP (100) PERCENT dbo.tc_kunjungan.no_mr, dbo.mt_master_pasien.nama_pasien, dbo.mt_master_pasien.tgl_lhr, dbo.mt_master_pasien.kode_agama, 
                      dbo.mt_master_pasien.kode_pendidikan, dbo.tc_kunjungan.no_registrasi, dbo.mt_master_pasien.gol_darah, dbo.tc_kunjungan.tgl_masuk, 
                      dbo.tc_kunjungan.tgl_keluar, dbo.mt_bagian.nama_bagian, dbo.mt_karyawan.nama_pegawai, dbo.mt_bagian.kode_bagian, dbo.tc_kunjungan.status_keluar, 
                      dbo.mt_karyawan.kode_dokter, dbo.tc_kunjungan.no_kunjungan, dbo.gd_tc_gawat_darurat.kode_gd, dbo.tc_registrasi.kode_kelompok, 
                      dbo.tc_registrasi.kode_perusahaan, dbo.tc_kunjungan.status_batal, YEAR(dbo.tc_kunjungan.tgl_masuk) AS Expr1, dbo.pm_tc_penunjang.kode_penunjang
...
GROUP BY dbo.tc_kunjungan.no_mr, dbo.mt_master_pasien.nama_pasien, dbo.mt_master_pasien.tgl_lhr, dbo.mt_master_pasien.kode_agama, 
                      ...
                      dbo.tc_kunjungan.tgl_keluar, dbo.mt_bagian.nama_bagian, dbo.mt_karyawan.nama_pegawai, dbo.mt_bagian.kode_bagian, dbo.tc_kunjungan.status_keluar, 
                      dbo.mt_karyawan.kode_dokter, dbo.tc_kunjungan.no_kunjungan, dbo.gd_tc_gawat_darurat.kode_gd, dbo.tc_registrasi.kode_kelompok, 
                      dbo.tc_registrasi.kode_perusahaan, dbo.tc_kunjungan.status_batal, YEAR(dbo.tc_kunjungan.tgl_masuk), dbo.pm_tc_penunjang.kode_penunjang
HAVING      (dbo.tc_kunjungan.status_batal IS NULL) AND (YEAR(dbo.tc_kunjungan.tgl_masuk) >= 2016) AND (dbo.mt_bagian.kode_bagian = '050401')
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [rj_mt_pasien_penunjang_v]");
    }
};
