...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.lap_biaya_op_rs_debet_v
AS
SELECT     dbo.mt_biaya_op_rs_v.kode_biaya, dbo.mt_biaya_op_rs_v.nama_biaya, dbo.mt_biaya_op_rs_v.kode_ref, dbo.mt_biaya_op_rs_v.referensi, 
                      ...
                      THEN 0 ELSE tx_nominal END) AS debet, MONTH(dbo.tx_harian.tx_tgl) AS bulan, YEAR(dbo.tx_harian.tx_tgl) AS tahun, dbo.tx_harian.tx_tipe
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [lap_biaya_op_rs_debet_v]");
    }
};
