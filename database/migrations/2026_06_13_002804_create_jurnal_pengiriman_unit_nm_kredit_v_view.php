...
HAVING      (dbo.tc_permintaan_inst_nm_det.jumlah_penerimaan > 0) AND (dbo.mapping_transaksi_rs_v.kode_proses = 13) AND (dbo.mt_rekap_stok_nm.kode_bagian_gudang = '070101') AND 
                      (dbo.mapping_transaksi_rs_v.acc_kredit > N'0') AND (dbo.mt_rekap_stok_nm.harga_beli * dbo.tc_permintaan_inst_nm_det.jumlah_penerimaan > 0) AND (dbo.mt_barang_jasa.kode_golongan = 'F01')
