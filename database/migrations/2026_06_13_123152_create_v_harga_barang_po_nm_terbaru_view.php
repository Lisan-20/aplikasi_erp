...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE VIEW dbo.v_harga_barang_po_nm_terbaru
AS
SELECT     TOP (100) PERCENT dbo.tc_po_nm_det.kode_brg, dbo.tc_po_nm_det.harga_satuan AS harga_satuan_netto, dbo.tc_po_nm.kodesupplier, 
                      dbo.mt_supplier.namasupplier, dbo.mt_barang_nm.nama_brg, dbo.tc_po_nm.no_po, dbo.tc_po_nm.id_tc_po, dbo.tc_po_nm_det.id_tc_po_det, 
...
FROM         dbo.tc_po_nm INNER JOIN
                      ...
                      dbo.mt_barang_nm ON dbo.tc_po_nm_det.kode_brg = dbo.mt_barang_nm.kode_brg
