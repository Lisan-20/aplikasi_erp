...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.lap_kondisi_pasien_plang_ri_v
AS
SELECT     TOP (100) PERCENT dbo.mt_master_pasien.no_mr, dbo.tc_registrasi.no_registrasi, dbo.tc_kunjungan.no_kunjungan, dbo.ri_tc_rawatinap.kode_ri, dbo.mt_master_pasien.nama_pasien, 
                      ...
                      dbo.tc_registrasi.stat_pasien, dbo.th_riwayat_pasien_grup.diagnosa_akhir, dbo.mt_master_pasien.flag_kelamin, dbo.ri_tc_riwayat_kelas.ket_keluar, dbo.tc_registrasi.umur
FROM         dbo.tc_kunjungan INNER JOIN
                      ...
                      dbo.th_riwayat_pasien_grup ON dbo.tc_kunjungan.no_kunjungan = dbo.th_riwayat_pasien_grup.no_kunjungan INNER JOIN
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [lap_kondisi_pasien_plang_ri_v]");
    }
};
