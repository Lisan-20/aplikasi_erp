...
return new class extends Migration
{
    ...
    {
        DB::unprepared("CREATE OR ALTER PROCEDURE [dbo].[inp_fee_dokter_rinap_temp_sp]
...
select kode_dr,no_kunjungan,no_registrasi,no_mr,seri_kuitansi,no_kuitansi,tgl_transaksi,tgl_kuitansi,kode_bagian,nama_tindakan,kode_trans_pelayanan,@saldo_dokter-diskon_dr1 as jumlah,@no_induk,'1' as flag_umum,kode_kelompok,kode_perusahaan
...
select kode_dr,no_kunjungan,no_registrasi,no_mr,seri_kuitansi,no_kuitansi,tgl_transaksi,tgl_kuitansi,kode_bagian,nama_tindakan,kode_trans_pelayanan,@saldo_dokter-diskon_dr2 as jumlah,@no_induk,'1' as flag_umum
...
-- pasien asuransi
insert into fee_dokter_rinap_temp(kode_dr,no_kunjungan,no_registrasi,no_mr,seri_kuitansi,no_kuitansi,tgl_transaksi,tgl_kuitansi,kode_bagian,nama_tindakan,kode_trans_pelayanan,jumlah,no_induk,flag_ass,kode_kelompok,kode_perusahaan)
...
");
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS inp_fee_dokter_rinap_temp_sp");
    }
};
