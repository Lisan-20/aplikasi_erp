...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.perhitungan_bpjs_lebihdri5thn_baru_v
AS
...
WHERE     (dbo.tc_registrasi.tgl_jam_keluar IS NOT NULL) AND (dbo.tc_trans_pelayanan.kode_kelompok IN (8, 9, 10, 11, 12)) AND (dbo.tc_registrasi.tgl_jam_keluar BETWEEN CONVERT(DATETIME, 
                      ...
                      (NOT (dbo.tc_registrasi.no_registrasi IN
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [perhitungan_bpjs_lebihdri5thn_baru_v]");
    }
};
