...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.his_umdumum_v
AS
SELECT     dbo.transaksi_umd.kode_bagian, dbo.mt_bagian.nama_bagian, dbo.transaksi_umd.no_bukti, dbo.transaksi_umd.tgl_transaksi, 
                      ...
                      dbo.transaksi_umd.inp_tgl, dbo.transaksi_umd.id_trans_umd, dbo.transaksi_umd.inp_id, dbo.mt_barang_jasa.nama_brg, dbo.transaksi_umd_detail.jumlah_besar, 
                      dbo.transaksi_umd_detail.satuan, dbo.transaksi_umd_detail.harga_satuan_netto, dbo.transaksi_umd.acc_no_2, dbo.transaksi_umd.minggu, 
                      dbo.mt_supplier.namasupplier
FROM         dbo.mt_barang_jasa INNER JOIN
                      dbo.transaksi_umd_detail ON dbo.mt_barang_jasa.kode_brg = dbo.transaksi_umd_detail.kode_brg RIGHT OUTER JOIN
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [his_umdumum_v]");
    }
};
