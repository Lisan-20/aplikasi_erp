...
insert into tran_sed (no_registrasi,no_kunjungan,no_mr,tx_nominal,jumlah,jenis_tindakan,kode,kode_tc_trans_kasir,kode_barang,nama_tindakan,tgl_jam,kode_dr,kode_trans_far,kode_bagian,kode_bagian_asal,kode_trans_pelayanan,kode_kelompok,kode_perusahaan,kode_tarif,tgl_input,no_kuitansi,seri_kuitansi,kd_tr_resep) select no_registrasi,no_kunjungan,no_mr,(bill_rs-bill_rs_ret) as tx_nominal, (jumlah-jumlah_ret)as jumlah,jenis_tindakan,11 as kode,kode_tc_trans_kasir,kode_barang,nama_tindakan,tgl_jam,kode_dokter1 as kode_dr,kode_trans_far,kode_bagian_asal as kode_bagian,kode_bagian as kode_bagian_asal,kode_trans_pelayanan,kode_kelompok,kode_perusahaan,kode_tarif,getdate() as tgl_input,no_kuitansi,seri_kuitansi,kd_tr_resep from v_trans_far_ASKES_RJ where flag_jurnal=0 and bill_rs>0;
");
    }
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS inp_tran_sed_far_ASKES_RJ_sp");
    }
};
