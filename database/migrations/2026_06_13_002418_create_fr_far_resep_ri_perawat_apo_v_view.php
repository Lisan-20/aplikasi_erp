...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.fr_far_resep_ri_perawat_apo_v
AS
...
WHERE     (dbo.tc_registrasi.status_batal IS NULL) AND (dbo.fr_far_resep_ri_dokter.flag_perawat = 1)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [fr_far_resep_ri_perawat_apo_v]");
    }
};
