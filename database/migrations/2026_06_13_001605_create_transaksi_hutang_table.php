...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('transaksi_hutang', function (Blueprint $table) {
            ...
            $table->decimal('jumlah_ppn', 18)->nullable();
            $table->decimal('jumlah_pph', 18)->nullable();
            $table->decimal('total', 18)->nullable();
            $table->integer('id_bd_tc_trans')->nullable();
            $table->string('referensi')->nullable();
            $table->integer('no_urut')->nullable();
            $table->decimal('jml_diskon', 18)->nullable();
            $table->integer('flag_mgt')->nullable();

            $table->primary(['id_trans_hutang'], 'pk_transaksi_hutang');
        });
    }
