...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('tc_cppt_sbar')) {
            return;
        }

        Schema::create('tc_cppt_sbar', function (Blueprint $table) {
            $table->increments('Id');
            ...
            $table->string('kel_kronologis', 250)->nullable();
            $table->text('ttd_kel_kronologis')->nullable();
            $table->text('hp_i')->nullable();
            $table->integer('id_user_dok')->nullable();
    ...
    {
        Schema::dropIfExists('tc_cppt_sbar');
    }
};
