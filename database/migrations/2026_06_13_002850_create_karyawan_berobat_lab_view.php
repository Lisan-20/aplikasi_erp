...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.karyawan_berobat_lab
AS
...
HAVING      (dbo.tc_trans_pelayanan.jenis_tindakan IN (3)) AND (dbo.tc_trans_pelayanan.kode_bagian = '050101')
ORDER BY bln
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [karyawan_berobat_lab]");
    }
};
