...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.tc_tarif_drgigi_v
AS
...
GROUP BY dbo.tc_trans_pelayanan.kode_dokter1, dbo.tc_trans_pelayanan.kode_kelompok, dbo.tc_trans_kasir.tgl_jam, dbo.tc_trans_pelayanan.flag_dr1, dbo.tc_trans_kasir.seri_kuitansi, 
                      dbo.tc_trans_pelayanan.kode_tc_trans_kasir, dbo.tc_trans_kasir.kode_bagian, dbo.tc_trans_pelayanan.status_batal
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [tc_tarif_drgigi_v]");
    }
};
