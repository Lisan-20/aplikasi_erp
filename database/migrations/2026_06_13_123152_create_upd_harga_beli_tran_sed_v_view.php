...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.upd_harga_beli_tran_sed_v
AS
...
WHERE     (dbo.tran_sed.jumlah > 0) AND (dbo.tran_sed.kode <> 2) AND (dbo.tran_sed.jenis_tindakan = 11)
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [upd_harga_beli_tran_sed_v]");
    }
};
