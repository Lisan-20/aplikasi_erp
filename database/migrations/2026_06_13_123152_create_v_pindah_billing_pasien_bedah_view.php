...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.v_pindah_billing_pasien_bedah
AS
SELECT     TOP (100) PERCENT dbo.mt_master_tarif.kode_tarif, dbo.mt_master_tarif.nama_tarif, dbo.mt_master_tarif.kode_bagian, dbo.mt_bagian.nama_bagian, 
                      ...
                      dbo.mt_master_tarif_detail_bedah.bill_dr1, dbo.mt_master_tarif_detail_bedah.bill_dr2, dbo.mt_master_tarif_detail_bedah.total, 
                      ...
                      dbo.mt_master_tarif_detail_bedah.no_urut, 
                      dbo.mt_master_tarif_detail_bedah.bill_rs + dbo.mt_master_tarif_detail_bedah.bill_dr1 + dbo.mt_master_tarif_detail_bedah.bill_dr2 AS total_trans, 
                      dbo.tc_trans_pelayanan.bill_rs_jatah + dbo.tc_trans_pelayanan.bill_dr1_jatah + dbo.tc_trans_pelayanan.bill_dr2_jatah AS total_trans_jatah, 
                      dbo.tc_bedah.status_penata, dbo.tc_trans_pelayanan.jumlah
FROM         dbo.mt_master_tarif INNER JOIN
                      ...
                      dbo.mt_master_tarif_detail_bedah.kode_klas = dbo.tc_trans_pelayanan.kode_klas AND 
                      dbo.mt_master_tarif_detail_bedah.no_urut = dbo.tc_trans_pelayanan.no_urut INNER JOIN
                      dbo.tc_bedah ON dbo.mt_bagian.kode_bagian = dbo.tc_bedah.kode_bagian AND dbo.tc_trans_pelayanan.id_bedah = dbo.tc_bedah.id_bedah
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [v_pindah_billing_pasien_bedah]");
    }
};
