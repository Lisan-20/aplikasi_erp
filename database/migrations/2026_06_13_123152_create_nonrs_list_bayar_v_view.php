...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.nonrs_list_bayar_v
AS
...
WHERE     (a.status_batal IS NULL) AND (a.jenis_tagih = 88)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [nonrs_list_bayar_v]");
    }
};
