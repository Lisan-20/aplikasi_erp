...
return new class extends Migration
{
    ...
    {
        DB::unprepared("CREATE OR ALTER PROCEDURE [dbo].[lap_kunjungan_unit_thn_detail_sp]
@tahun as int,
...
from laporan_kunjungan_unit2_v where kode_perusahaan=@kode_perusahaan and thn =@tahun;
--status pasien
...
");
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS lap_kunjungan_unit_thn_detail_sp");
    }
};
