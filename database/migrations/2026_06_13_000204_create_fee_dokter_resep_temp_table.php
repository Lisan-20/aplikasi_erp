...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('fee_dokter_resep_temp')) {
            return;
        }

        Schema::create('fee_dokter_resep_temp', function (Blueprint $table) {
            $table->increments('id_fee_dr_resep_temp');
    ...
    {
        Schema::dropIfExists('fee_dokter_resep_temp');
    }
};
