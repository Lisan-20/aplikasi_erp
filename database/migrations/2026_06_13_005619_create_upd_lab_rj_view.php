...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.upd_lab_rj
AS
...
WHERE     (dbo.mt_master_tarif.tingkatan = 5) AND (dbo.mt_master_tarif.kode_bagian = '050101') AND (dbo.mt_master_tarif_detail.kode_klas = 16)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [upd_lab_rj]");
    }
};
