...
return new class extends Migration
{
    ...
    {
        DB::unprepared("CREATE OR ALTER PROCEDURE [dbo].[lap_kunjungan_new]
@bln as int,
@thn as int,
@bagian as int
...
update lap_kunjungan_nasabah_all_v set umum1=umum, BpjsPbi1=BpjsPbi, BpjsNonPbi1=BpjsNonPbi, BpjsKtngkrja1=BpjsKtngkrja, jamkesda1=jamkesda, pt1=pt, asuransi1=asuransi, bagian=validasi_lap_rm  where bln = @bln and thn = @thn and validasi_lap_rm=@bagian
...
--update lap_kunjungan_plus48_all_v set plus48vvip1=plus48vvip, plus48vip1=plus48vip, plus4831=plus483, plus482a1=plus482a, plus4811=plus481 where bln = @bln and thn = @thn and validasi_lap_rm=@bagian
...
");
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS lap_kunjungan_new");
    }
};
