...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.dash_penerimaan_kasir2_kemenkes_v
AS
...
GROUP BY dbo.tc_trans_kasir.tgl_jam, dbo.tc_trans_kasir.no_registrasi, dbo.tc_trans_kasir.tunai, dbo.tc_trans_kasir.debet, dbo.tc_trans_kasir.kredit, 
                      ...
                      dbo.tc_trans_kasir.kode_perusahaan
HAVING      (dbo.tc_trans_kasir.kode_perusahaan = 380)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [dash_penerimaan_kasir2_kemenkes_v]");
    }
};
