...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.admin_mt_tarif_jamkesmas_v
AS
...
WHERE     (dbo.mt_master_tarif.tingkatan = 5) AND (dbo.mt_tgl_tarif.status = 1)
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [admin_mt_tarif_jamkesmas_v]");
    }
};
