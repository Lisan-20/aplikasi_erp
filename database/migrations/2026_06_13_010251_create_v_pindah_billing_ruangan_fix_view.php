...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.v_pindah_billing_ruangan_fix
AS
SELECT     dbo.tc_trans_pelayanan.kode_trans_pelayanan, dbo.tc_trans_pelayanan.kode_tc_trans_kasir, dbo.tc_trans_pelayanan.no_registrasi, dbo.tc_trans_pelayanan.bill_rs, 
                      ...
                      dbo.mt_master_tarif_ruangan.harga_bpjs, dbo.mt_master_tarif_ruangan.harga_inhealth
FROM         dbo.tc_trans_pelayanan INNER JOIN
                      dbo.mt_master_tarif_ruangan ON dbo.tc_trans_pelayanan.kode_klas = dbo.mt_master_tarif_ruangan.kode_klas AND 
                      dbo.tc_trans_pelayanan.kode_ruangan = dbo.mt_master_tarif_ruangan.kode_ruangan
WHERE     (dbo.tc_trans_pelayanan.kode_tc_trans_kasir IS NULL OR
                      dbo.tc_trans_pelayanan.kode_tc_trans_kasir = 0) AND (dbo.tc_trans_pelayanan.kode_tarif IS NULL) AND (dbo.tc_trans_pelayanan.jenis_tindakan IN (1)) AND 
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [v_pindah_billing_ruangan_fix]");
    }
};
