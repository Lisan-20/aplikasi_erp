...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.v_trans_pelayanan_pt_RI_v
AS
SELECT     dbo.tc_trans_pelayanan.kode_trans_pelayanan, dbo.tc_trans_pelayanan.kode_tc_trans_kasir, dbo.tc_trans_pelayanan.no_kunjungan, 
                      ...
                      dbo.tc_trans_pelayanan.bill_dr2, dbo.tc_trans_pelayanan.diskon_rs, dbo.tc_trans_pelayanan.diskon_dr1, dbo.tc_trans_pelayanan.diskon_dr2, 
...
WHERE     (dbo.tc_trans_pelayanan.flag_jurnal = 0) AND (dbo.tc_trans_kasir.status_batal IS NULL) AND (dbo.tc_trans_kasir.seri_kuitansi IN ('AI', 'RI')) AND 
                      (dbo.tc_trans_pelayanan.kode_kelompok = 5) AND (dbo.tc_registrasi.kode_perusahaan > 0) AND (dbo.mt_perusahaan.flag = 0 OR
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [v_trans_pelayanan_pt_RI_v]");
    }
};
