...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.jurnal_cogs_radiologi_ranap_v
AS
...
WHERE     (YEAR(dbo.tran_sed.tgl_jam) >= 2014) AND (dbo.tran_sed.tx_nominal > 0) AND (dbo.tran_sed.kode_bagian = '050201') AND (dbo.tran_sed.kode = 3) AND (dbo.tran_sed.kode_bagian_asal LIKE '03%')
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [jurnal_cogs_radiologi_ranap_v]");
    }
};
