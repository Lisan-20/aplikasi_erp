...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.laporan_ranap2_jamkesda_v
AS
...
HAVING      (dbo.tc_registrasi.kode_kelompok = 10) AND (dbo.tc_trans_kasir.status_batal IS NULL) AND (dbo.tc_trans_kasir.nk_perusahaan > 0) AND 
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [laporan_ranap2_jamkesda_v]");
    }
};
