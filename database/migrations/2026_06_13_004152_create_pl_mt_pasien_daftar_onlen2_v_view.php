...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.pl_mt_pasien_daftar_onlen2_v
AS
SELECT     TOP (100) PERCENT dbo.pl_tc_poli.id_pl_tc_poli, dbo.pl_tc_poli.kode_poli, dbo.pl_tc_poli.no_kunjungan, dbo.pl_tc_poli.kode_bagian, dbo.pl_tc_poli.no_antrian, dbo.pl_tc_poli.tgl_jam_poli, 
                      ...
                      dbo.pl_tc_poli.kode_jadwal, dbo.pl_tc_poli.status_isihasil, dbo.tc_registrasi.noSep, dbo.tc_registrasi.noKartuPeserta, dbo.mt_master_pasien.tlp_almt_ttp, dbo.tc_registrasi.flag_verif, 
                      dbo.tc_registrasi.flag_daftar, dbo.tc_registrasi.daftar_ol, dbo.tc_registrasi.flag_status, DATEDIFF(day, GETDATE(), dbo.pl_tc_poli.tgl_jam_poli) AS jml_hari, dbo.pl_tc_poli.jam_praktek, 
                      dbo.tc_registrasi.no_reg_inap, dbo.tc_registrasi.tgl_jam_keluar, dbo.tc_registrasi.flag_wa, dbo.pl_tc_poli.datang
...
WHERE     (dbo.tc_registrasi.status_batal IS NULL) AND (dbo.tc_kunjungan.tgl_keluar IS NULL) AND (dbo.tc_registrasi.daftar_ol IN (1)) AND (dbo.tc_registrasi.flag_verif IS NULL) AND 
                      (dbo.tc_registrasi.no_reg_inap IS NOT NULL)
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [pl_mt_pasien_daftar_onlen2_v]");
    }
};
