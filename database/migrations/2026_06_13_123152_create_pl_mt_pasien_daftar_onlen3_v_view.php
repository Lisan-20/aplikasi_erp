...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.pl_mt_pasien_daftar_onlen3_v
AS
SELECT     TOP (100) PERCENT dbo.pl_tc_poli.id_pl_tc_poli, dbo.pl_tc_poli.kode_poli, dbo.pl_tc_poli.no_kunjungan, dbo.pl_tc_poli.kode_bagian, dbo.pl_tc_poli.no_antrian, dbo.pl_tc_poli.tgl_jam_poli, 
                      ...
                      dbo.tc_registrasi.flag_daftar, dbo.tc_registrasi.daftar_ol, dbo.tc_registrasi.flag_status, dbo.pl_tc_poli.jam_praktek, dbo.tc_registrasi.no_reg_inap, dbo.tc_registrasi.tgl_jam_keluar, 
...
WHERE     (dbo.tc_registrasi.status_batal IS NULL) AND (dbo.tc_kunjungan.tgl_keluar IS NOT NULL) AND (dbo.tc_registrasi.daftar_ol IN (1)) AND (dbo.tc_registrasi.flag_verif IS NOT NULL) AND 
                      (dbo.tc_registrasi.no_reg_inap IS NOT NULL) AND (dbo.tc_registrasi.tgl_jam_keluar IS NOT NULL)
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [pl_mt_pasien_daftar_onlen3_v]");
    }
};
