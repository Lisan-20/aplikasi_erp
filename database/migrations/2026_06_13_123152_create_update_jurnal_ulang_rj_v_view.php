...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.update_jurnal_ulang_rj_v
AS
...
WHERE     (YEAR(dbo.tc_trans_kasir.tgl_jam) = 2017) AND (dbo.tc_trans_kasir.seri_kuitansi IN ('AJ', 'RJ')) AND (dbo.tc_trans_kasir.tgl_ver IS NOT NULL)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [update_jurnal_ulang_rj_v]");
    }
};
