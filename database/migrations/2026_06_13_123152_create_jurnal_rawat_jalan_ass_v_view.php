...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.jurnal_rawat_jalan_ass_v
AS
...
WHERE     (dbo.mapping_transaksi_rs_v.kode_proses = 2) AND (dbo.tc_trans_kasir.seri_kuitansi IN ('AJ', 'RJ')) AND (dbo.tc_trans_pelayanan.kode_barang IS NULL) AND 
                      ...
                      (dbo.tc_registrasi.kode_perusahaan > 0) AND (dbo.tc_trans_pelayanan.bill_dr1_jatah = 0 OR
                      dbo.tc_trans_pelayanan.bill_dr1_jatah IS NULL)
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [jurnal_rawat_jalan_ass_v]");
    }
};
