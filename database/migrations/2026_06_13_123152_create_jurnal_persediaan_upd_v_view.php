...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.jurnal_persediaan_upd_v
AS
...
WHERE     (dbo.tc_permintaan_inst_det.jumlah_penerimaan > 0) AND (dbo.mapping_transaksi_rs_v.kode_proses = 6) AND (dbo.mapping_transaksi_rs_v.acc_debet > N'0') AND 
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [jurnal_persediaan_upd_v]");
    }
};
