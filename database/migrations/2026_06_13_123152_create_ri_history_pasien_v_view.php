...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.ri_history_pasien_v
AS
SELECT     dbo.mt_master_pasien.no_mr, dbo.tc_registrasi.no_registrasi, dbo.tc_kunjungan.no_kunjungan, dbo.ri_tc_rawatinap.kode_ri, dbo.mt_master_pasien.nama_pasien, 
                      ...
                      dbo.tc_kunjungan.kode_bagian_tujuan, dbo.tc_kunjungan.status_blpl, dbo.tc_kunjungan.tgl_pulang, dbo.tc_registrasi.plafon_bpjs
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [ri_history_pasien_v]");
    }
};
