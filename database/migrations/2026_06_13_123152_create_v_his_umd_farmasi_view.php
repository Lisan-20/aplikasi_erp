...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.v_his_umd_farmasi
AS
...
GROUP BY dbo.transaksi_umd.kode_bagian, dbo.mt_bagian.nama_bagian, dbo.transaksi_umd.no_bukti, dbo.transaksi_umd.tgl_transaksi, dbo.transaksi_umd.kode_supplier, dbo.transaksi_umd.inp_tgl, 
                      dbo.transaksi_umd.id_trans_umd, dbo.transaksi_umd.inp_id
HAVING      (dbo.transaksi_umd.kode_bagian = '060201')
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [v_his_umd_farmasi]");
    }
};
