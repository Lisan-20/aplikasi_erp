...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.master_pasien_umum_srv_v
AS
...
WHERE     (NOT (kode_perusahaan NOT LIKE '%UMUM%'))
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [master_pasien_umum_srv_v]");
    }
};
