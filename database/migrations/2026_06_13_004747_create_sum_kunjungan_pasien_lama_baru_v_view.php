...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.sum_kunjungan_pasien_lama_baru_v
AS
SELECT     TOP (100) PERCENT dbo.kunjungan_pasien_baru_v.bln, dbo.kunjungan_pasien_lama_v.thn, dbo.kunjungan_pasien_baru_v.kode_bagian_tujuan, 
                      ...
                      dbo.kunjungan_pasien_lama_v.perusahaan
FROM         dbo.kunjungan_pasien_baru_v INNER JOIN
                      ...
                      dbo.kunjungan_pasien_baru_v.perusahaan = dbo.kunjungan_pasien_lama_v.perusahaan
GROUP BY dbo.kunjungan_pasien_baru_v.bln, dbo.kunjungan_pasien_lama_v.thn, dbo.kunjungan_pasien_baru_v.kode_bagian_tujuan, 
                      dbo.kunjungan_pasien_baru_v.kode_kelompok, dbo.kunjungan_pasien_lama_v.perusahaan
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [sum_kunjungan_pasien_lama_baru_v]");
    }
};
