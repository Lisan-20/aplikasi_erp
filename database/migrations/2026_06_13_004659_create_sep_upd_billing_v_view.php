...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.sep_upd_billing_v
AS
SELECT     dbo.tc_trans_kasir.no_mr AS Expr1, dbo.tc_trans_kasir.nk_perusahaan, dbo.tc_trans_kasir.tgl_jam, dbo.tc_trans_kasir.seri_kuitansi, dbo.tc_registrasi.tgl_jam_keluar, 
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [sep_upd_billing_v]");
    }
};
