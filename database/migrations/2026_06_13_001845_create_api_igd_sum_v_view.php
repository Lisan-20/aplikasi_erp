...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.api_igd_sum
AS
SELECT        MONTH(dbo.tc_registrasi.tgl_jam_masuk) AS bln, YEAR(dbo.tc_registrasi.tgl_jam_masuk) AS thn, COUNT(dbo.tc_registrasi.kode_kelompok) AS jml, 
                         dbo.mt_bagian.kode_bagian, dbo.tc_registrasi.kode_kelompok, dbo.mt_nasabah.nama_kelompok
...
GROUP BY MONTH(dbo.tc_registrasi.tgl_jam_masuk), YEAR(dbo.tc_registrasi.tgl_jam_masuk), dbo.mt_bagian.kode_bagian, dbo.tc_registrasi.kode_kelompok, 
                         dbo.mt_nasabah.nama_kelompok
HAVING        (dbo.mt_bagian.kode_bagian LIKE '02%')
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [api_igd_sum_v]");
    }
};
