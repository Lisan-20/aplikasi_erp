...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.v_jurnal_tran_sed_RI_debet
AS
...
WHERE     (dbo.mapping_transaksi_rs_v.kode_proses = 2) AND (dbo.mapping_transaksi_rs_v.acc_debet > 0) AND (dbo.tran_sed.seri_kuitansi IN ('AI', 'RI'))
...
");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [v_jurnal_tran_sed_RI_debet]");
    }
};
