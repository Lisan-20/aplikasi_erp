...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR ALTER VIEW dbo.inp_fee_dr2_ass_temp_v
AS
SELECT     dbo.tc_trans_pelayanan.kode_trans_pelayanan, dbo.tc_trans_pelayanan.kode_tc_trans_kasir, dbo.tc_trans_pelayanan.no_kunjungan, 
                      ...
                      dbo.tc_trans_pelayanan.kode_bagian, (CASE WHEN dbo.tc_trans_pelayanan.diskon_dr2 IS NULL THEN 0 ELSE dbo.tc_trans_pelayanan.diskon_dr2 END) 
...
WHERE     (dbo.tc_trans_pelayanan.kode_kelompok = 3) AND (dbo.tc_trans_pelayanan.kode_perusahaan > 0) AND (dbo.tc_trans_pelayanan.flag_dr2 IS NULL OR
                      dbo.tc_trans_pelayanan.flag_dr2 = 0) AND (dbo.tc_trans_pelayanan.kode_dokter2 > 0) AND (dbo.tc_trans_pelayanan.status_batal IS NULL) AND 
                      (dbo.tc_trans_pelayanan.bill_dr2 > 0)
");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS [inp_fee_dr2_ass_temp_v]");
    }
};
